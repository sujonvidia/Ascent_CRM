			...
			<div id="ribbon">
				...
				<ol class="breadcrumb">
					<li style="text-align: center;color: #474544;">
                        ...
                        <ul class="dropdown-menu pull-left" style="margin-left: 1.1%;">
	...
	<script type="text/javascript">
        ...
        function openProperties(projectID,attr){
            ...
            flatpick_start=$("#projectstartDate"+projectID).flatpickr({
                //inline: true, 
                enableTime : true,
                //minDate: moment().format('MMM-DD-YYYY HH:mm:ss'),
		...
		function setProjectAttribute(data){
            ...
            $.each(data.projects, function (key, value) {
				...
				var projectitem = '<div class="panel panel-default notifation inactive notifationDel" data-cdate="'+data.projects[key].CreatedDate+'" id="clickDiv'+data.projects[key].Id+'" data-proid = "'+data.projects[key].Id+'">';
					...
					projectitem += '						<span class="name"><b class="textdecor" id="protitle'+data.projects[key].Id+'">'+data.projects[key].Title+'</b> <span style="margin-right: 0%;" class="margintop0 pull-right"><img class="noBorder" id="propertiesIMG'+data.projects[key].Id+'" data-projectid="'+data.projects[key].Id+'" data-type="properties"  src="<?php echo base_url("asset/img/icons/Details_Properties.png"); ?>" /></span><span class="margintop0 pull-right"><img class="noBorder" id="attachIMG'+data.projects[key].Id+'" data-projectid="'+data.projects[key].Id+'" data-type="attach" src="<?php echo base_url("asset/img/icons/Add File.png"); ?>" /><span class="tipT" id="tipA'+data.projects[key].Id+'">'+uA+'</span><img class="noBorder" id="commentsIMG'+data.projects[key].Id+'" data-projectid="'+data.projects[key].Id+'" data-type="comments"  src="<?php echo base_url("asset/img/icons/Chat.png"); ?>" /><span class="tipT" id="tipT'+data.projects[key].Id+'">'+uc+'</span></span></span>';
					projectitem += '					</div>';
	...
	<script type="text/javascript">
        ...
        function propertiesTabsOne(projectid){
            ...
            var tabDetail ='  <div class="row">';
                ...
                tabDetail +='                   <input type="text" data-c="1"  name="projectStartdate" onclick="togglecalendar_start()" onfocus="this.placeholder = \'\'" onblur="this.placeholder = \'Startdate\'" class="col-lg-4 proInputText" placeholder="Startdate" id="projectstartDate'+projectid+'" value="">';
                tabDetail +='</div>';
            ...
            var vColor = 'inherit';
                ...
                if(data.allTask.length > 0){
                    ...
                    $.each(data.allTask, function (i, item) {
                            ...
                            taskDetailStr += '                  <div class="col-lg-9 col-sm-9 col-md-9 taskRow taskRowCus" style="width:72%;margin-bottom:-1%;"> ';                  
                            taskDetailStr += '                      <div class="col-lg-1 hover" style="height:55px;">';
                            taskDetailStr += '                          <div class="row text-center">';
                            taskDetailStr += '                              <div class="icon-check iconGray iradio_square-blue"  onClick="makeComplete(' + item.Id + ',\''+item.Status+'\',\'Task\');" id="iconGray' + item.Id + '" style="display:'+sty2+';" ></div>';
                            taskDetailStr += '                              <div class="icon-check iconGreen iradio_square-blue checked" onClick="makeComplete(' + item.Id + ',\''+item.Status+'\',\'Task\');" id="iconGreen' + item.Id + '" style="display:'+sty1+';" ></div>';                      
                            taskDetailStr += '                          </div>';
                            taskDetailStr += '                          <div class="row" id="subTaskcountbtnValue' + item.Id + '">';
                            taskDetailStr += '                          </div>';
                            taskDetailStr += '                      </div>';
                            taskDetailStr += '                      <div class="col-lg-11 hover">';
                            taskDetailStr += '                          <span data-serial="' + item.Id + '" id="tasktext' + item.Id + '" class="from proName clickontitle">' + item.Title + '</span><img id="open_newpro1" title="Create Subtask" onclick="openInput('+item.Id+')" style="cursor: pointer;margin-left: 1%;margin-top: -1%;width: 20px;height: 20px;background: #ffffff  !important;" class="open_newpro1" src="http://172.16.0.64/nclive/asset/img/icons/Add Project.png">';                    
                            taskDetailStr += '                          <p class="name check"  style="width: 115%;">';                          
                            taskDetailStr += '                              <span class="span1">Start Date: <input style="width: 15%;" onclick="togglecalendar_startPro(' + item.Id + ',$(this).data(\'c\'))" data-c = "1" type="text" id="startDatein' + item.Id + '" name="mydate" class="datepicker customdate" data-dateformat="M d yy"  value="'+moment(item.Startdate).format('MMM DD YYYY')+'">, </span>';
                            taskDetailStr += '                              <span class="span2">Duration: <input type="text" class="duarationClass" onchange="getDuration($(this).data(\'id\'),' + item.Id + ',\'startDatein\')" data-id="duration' + item.Id + '" id="duration' + item.Id + '" value="'+days+'"> days, </span>';                            
                            taskDetailStr += '                              <span class="span3" style="margin-left: 0%;">Due Date: <input onclick="togglecalendar_endPro(' + item.Id + ')" type="text" id="endDatein' + item.Id + '" style="color:'+vColor+';width: 15%;" name="mydate" class="datepicker customdate" data-dateformat="M d yy" value="'+EnddateC+'">, &nbsp; <span style="    z-index: 100;position: relative;">Status: <span clas="link_status_text'+item.Id+'  dt-todostatus" id="openstatus'+item.Id+'" data-type="'+item.Type+'" data-serial="'+item.Id+'" data-status="'+item.Status+'" >'+item.Status+'</span></span> </span>';  

                            taskDetailStr += '                          </p>';
                            taskDetailStr += '                      </div>';    
                            taskDetailStr += '                  </div>';
                            taskDetailStr += '                  <div class="col-lg-3 col-sm-3 col-md-3 imgRow hover imgrowTask"  style="    width: 30%;height: 55px;margin-left: -2%;">';
                            taskDetailStr += '                      <div class="pull-right">';
                            taskDetailStr += '                          <img title="Supervisor And Member(s) List" class="icon-todo-menu onIconClick '+(data.nty_chat[i][0].total > 0 ? 'active-icon' : '')+'" id="clickIconlist' + item.Id + '" src="icons/Profile.png" " >';
                            taskDetailStr += '                          <img data-toggle="tooltip" data-placement="bottom" title="Chat" onClick="qtipComment(event,this, ' + item.Id + ')" class="icon-todo-menu" src="icons/Chat.png"><span class="tipT" id="tipTT'+item.Id+'">'+uCc+'</span>';
                            
                            taskDetailStr += '                          <img data-toggle="tooltip" data-placement="bottom" title="Sticky Note" id="stickynote' + item.Id + '" class="icon-todo-menu open-stickynote">';
                            //taskDetailStr += '                          <img data-toggle="tooltip" data-placement="bottom" title="Subtask" class="icon-todo-menu" id="subTaskcountbtn' + item.Id + '" onClick="openInput(' + item.Id + ')" src="icons/Subtask.png" style="margin: 0px;border-radius: 0px;margin-top: 0px;padding-right: 0px;">';
                            taskDetailStr += '                          <img data-toggle="tooltip" data-placement="bottom" title="Manage File" onClick="qtipAttach(this,' + item.Id + ',' + item.CreatedBy + ',\'' + item.CreatedDate + '\')" class="icon-todo-menu qtip-attach'+item.Id+'" src="icons/Add File.png"><span class="tipT" id="tipAT'+item.Id+'">'+uAa+'</span>';
                            taskDetailStr += '                          <img id="openQtipProperty' + item.Id + '" title="Task Properties" class="icon-todo-menu" src="icons/Details_Properties.png">';
                            taskDetailStr += '                      </div>';
                            taskDetailStr += '                  </div>';
                            ...
                            if(getCookie('completechecking') === item.Id){
                            ...
                            if(item.Status == 'initiated'){
                                $("#openstatus"+item.Id).css('color','#6EA7F2');
                            }
                           ...
                           var fpstart= flatpickr("#startDatein"+item.Id, {
                            ...
                            var fpend= flatpickr("#endDatein"+item.Id, {
                                ...
                                onChange: function(selectedDates, dateStr, instance) {
                                    ...
                                    $.ajax({
                                        url: '<?php echo site_url() . "Projects/getProDueDate"; ?>',
                                        type: 'POST',
                                        data: {
                ...
                if (e.keyCode == 13) {
					if($("#newTaskInput").hasClass('todo-searchmode')){
                        ...
                        $('.taskDetailDive').each(function(k,v){
                            ...
                            if($(v).find('.proName').text().indexOf(task_name)>-1){
                                $(v).show();
                            }else{
                                $(v).hide();
                            }
                        ...
                        $('.subtaskDetailDive').each(function(k,v){
                            ...
                            if($(v).find('.proNameSub').text().indexOf(task_name)>-1){
                                $(v).show();
                ...
                success: function (data_st, textStatus) {
                    ...
                    if(data_st.allSubTask.length > 0){
                        $.each(data_st.allSubTask, function (index, value) {
                            ...
                            subtaskList +='      </div>'; 
                            subtaskList += '     <div draggable="true" ondragstart="drag(event,'+value.Id+')"  class="row bottom-border '+clas+' subtaskDetailDive '+status+'" id="subtaskDetailDive'+value.Id+'">';              
                            subtaskList +='         <div class="col-lg-10 col-sm-10 col-md-10 taskRow" style="margin-top: 5px;">    ';                  
                                             
                            subtaskList +='             <div class="col-lg-1">';
                            subtaskList +='                 <div class="row text-center">';
                            //subtaskList +='                       <img class="icon-check" src="icons/Checkmark.png">';    
                            subtaskList += '                    <div class="icon-check iconGray iradio_square-blue"  onClick="makeComplete(' + value.Id + ',\''+value.Status+'\',\'SubTask\');" id="iconGray' + value.Id + '" style="display:'+sty2+';" ></div>';
                            subtaskList += '                    <div class="icon-check iconGreen iradio_square-blue checked" onClick="makeComplete(' + value.Id + ',\''+value.Status+'\',\'SubTask\');" id="iconGreen' + value.Id + '" style="display:'+sty1+';" ></div>';                    
                            subtaskList +='                 </div>';
                            subtaskList +='             </div>';
                            subtaskList +='             <div class="col-lg-11">';
                            subtaskList +='                 <span data-serial="' + value.Id + '" class="from proNameSub clickontitle" id="subtasktitle'+value.Id+'">'+ value.Title +'</span>';                      
                            subtaskList += '                <p class="name" style="width: 115%;margin-bottom:0px;">';                           
                            subtaskList += '                    <span class="span1">Start Date: <input type="text" style="width:11.5% !important;" id="SubstartDatein' + value.Id + '" onclick="togsubcalstart(' + value.Id + ')" name="" class="datepicker customdate" data-dateformat="M d yy"  value="'+moment(value.Startdate).format('MMM DD YYYY')+'">, </span>';
                            subtaskList += '                              <span class="span2">Duration: <input type="text" class="duarationClass" onchange="getDuration($(this).data(\'id\'),' + value.Id + ',\'SubstartDatein\')" data-id="Subduration' + value.Id + '" id="Subduration' + value.Id + '" value="'+days+'"> days, </span>';  
                            //subtaskList += '                  <span class="span2" class="span2">Duration: <span id="Subduration' + value.Id + '">'+days+'</span> days</span>';                            
                            subtaskList += '                    <span style="margin-left: 0%;">Due Date: <input  style="width:11.5% !important;" type="text" onclick="togsubcalend(' + value.Id + ')" id="SubendDatein' + value.Id + '" style="color:'+vColor+';" name="mydate" class="datepicker customdate" data-dateformat="M d yy" value="'+EnddateC+'">,&nbsp; <span style="    z-index: 100;position: relative;">Status: <span clas="link_status_text'+value.Id+'  dt-todostatus" id="openstatus'+value.Id+'" data-type="'+value.Type+'" data-serial="'+value.Id+'" data-status="'+value.Status+'" >'+value.Status+'</span></span>';                  
                            subtaskList += '                </p>';
                            subtaskList +='             </div>';    
                            subtaskList +='         </div>';                    
                            subtaskList +='         <div class="col-lg-2 col-sm-2 col-md-2 imgRow" style="margin-top: 5px;">';                      
                            subtaskList +='             <div class="pull-right">';                          
                            subtaskList += '                <img class="icon-todo-menu SubonIconClick '+(data_st.nty_chat[index][0].total > 0 ? 'active-icon' : '')+'" id="SubclickIconlist' + value.Id + '"src="icons/Profile.png" >';
                            subtaskList += '                <div class="dropdownCus">'; 
                            subtaskList +='                     <img class="icon-todo-menu dropbtn" src="icons/Details_Properties.png">';
                            subtaskList += '                    <div class="dropdownCus-content">'; 
                            ...
                            if(getCookie('completechecking') === value.Id){
                            ...
                            if(value.Status == 'initiated'){
                                $("#openstatus"+value.Id).css('color','#6EA7F2');
                            }
                            ...
                            $('#SubopenQtipProperty'+value.Id).click(function(){
                                 qtipProperties(this,value,'SubTask');
                            });
	    ...
	    function countsabtask(pro_id){
	    	...
	    	$.ajax({
                ...
                success: function (data_st, textStatus) {
                    ...
                    if(totalSabtask > 0){
						$("#subTaskcountbtnValue"+pro_id).html('<button id="subTaskcountbtn' + pro_id + '" class="btn bg-color-blueDark txt-color-white subTaskcountbtn">'+totalSabtask+' <i class="fa fa-caret-down" id="subTaskcountbtn' + pro_id + 'i"></i></button>');
					}else{
			...
			$.ajax({
                ...
                success: function (data_st, textStatus) {
                    if(data_st.msg != 'TIMELESS'){
                        ...
                        swal("Oops...", ttype+" Enddate check.", "error");
                        fun_loadfulltable($("#newTaskInput").attr('data-projectid'),'ASC','All');
                    }
...
<script type="text/javascript">
    ...
    function togglecalendar_startPro(serial,status){
        
        $.each(arr_fpstart,function(k,v){
            if(v.Id == serial){
                console.log(v.date.toggle());
            }
        })
    ...
    $(document).on('mouseover', '.subtaskDetailDive',function(e){
        $(this).find(".datepicker").css('background','lavender');
        $(this).find(".duarationClass").css('background','lavender');
    });

    $(document).on('mouseover', '.proName, .imgrowTask, .icon-check, .open_newpro1',function(e){
        $(this).closest( ".taskDetailDive " ).find(".taskRowCus").css('border-left','3px solid #1FEA9C');
        $(this).closest( ".taskDetailDive " ).find(".hover").css('background','lavender');
        $(this).closest( ".taskDetailDive " ).find(".check .datepicker").css('background','lavender');
        $(this).closest( ".taskDetailDive " ).find(".check .duarationClass").css('background','lavender');
    });
