...
/*---------------------------------------------------- LIST VIEW -----------------------------------------------------*/
    ...
    CustomView = fcViews.custom = View.extend({
        ...
        numberCellHtml: function (cell) {
            ...
            if (!this.dayNumbersVisible) { // if there are week numbers but not day numbers
                return '<td/>'; //  will create an empty space above events <span class="wp-smiley wp-emoji wp-emoji-sad" title=":(">:(</span>
            }
                        ...
                        if (!didAddDayHeader) {
                            tbody.append('\
                                <li class="my-fc-header" date="">\
                                    ...
                                    <span class="my-fc-header-date">' + currentDayStart.format('DD-MM-YYYY') + '</span>\
                                </li>');
 
                            didAddDayHeader = true;
                        }
						var temp_end = e.end.clone(); 
						
                        var segEl = $('\
                            <li class="my-fc-row">\
                                <div class="my-fc-check"><input type="checkbox"></div>\
                                <div class="my-fc-time">' + (e.allDay ? this.opt('allDayText') : e.start.format('HH:mm') + " - " + temp_end.subtract({'hours': 9}).format('HH:mm') ) + '</div>\
                                <div class="my-fc-title" style="color: rgb(55, 90, 127); font-weight: bold">' + e.title + '</div>\
                            </li>');
                        tbody.append(segEl);
