<script type="text/javascript">
	function SendInvite(type,typeID,selector){
        ...
        $(".taskDiv ").append(inviteFunction(type,typeID,selector));
        addInviteEmail();
        ...
        $(".TaskListDiv .taskDiv").height(642);
    }

    function closeInvite(element){
        $("#taskInsertDiv").show();
        ...
        $("#inviteeDiv").remove();
        //$('#rarrow').trigger('click');
        $(".TaskListDiv .taskDiv").height(610);
    }
    ...
    function inviteFunction(type,typeID,selector){ 
        var inviteDiv  = '          <div id="inviteeDiv"> <div class="panel-body">'; 
            ...
            inviteDiv += '                                  <p class="emailbody"><span class="inviteeName"><?php echo $username; ?></span> has assigned a task to you using the <span class="inviteeName">Navigate Connect App.</span>';
            inviteDiv += '                                  Please click the link below to accept the invitation and start working on the task.<br><br>';
            inviteDiv += '                                  <span class="Inviteetitle">'+ type + ": " + $("#"+selector+typeID).text() + " under Project: " + $("#pronameSpan").text() +'</span>';
