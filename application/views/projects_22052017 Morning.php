        ...
        <div id="ribbon">
            ...
            <ol class="breadcrumb">
                <li style="text-align: center;color: #474544;">
                    ...
                    <span><i class="fa fa-pencil pronameSpan"></i></span>
                    <div class="ViewDiv" id="customExportDiv">               
                    </div>
                    <ul class="list-inline ribUl" id="ribUl">
                      <ol class="ribLi noBorder ribLi1" data-type="list" id="" data-projectid="">Task List</ol>
                      ...
                      <ol onclick="generatePreview(this)" class="ribLi noBorder ribLi5" data-type="properties" id="" data-projectid="">Dashboard</ol>
                    </ul>
...
function  removethis(inputID,imgName,taskid,type){
    ...
    <script type="text/javascript">
        ...
        function getAllProject(){
            ...
            $("#assign_A").hide();
            $("#assign_C").hide();
            var getproject_url = "<?php echo (isset($shared_activity_id))?"get_share_projects/".$id."/".$org_id."/".$shared_activity_id."/".$shared_activity_type:"getproject"; ?>";
            $.ajax({
                url: '<?php echo site_url(); ?>Projects/'+getproject_url,
                dataType: "JSON",
                beforeSend: function () {
                ...
                switch(param2){
                    ...
                    case 'properties':
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(data, status) {
                                            openProperties(projectID,param2,viewtype,projectID,data,data);
        ...
        function openProperties(projectID,attr,viewtype,projectID,data,data){
            ...
            var floatingDiv =  '<div data-attr="'+attr+projectID+'" id="backDiv'+attr+projectID+'">';
                ...
                floatingDiv += '                    <span id="todo_name_text'+projectID+'" class="task-properties">'+taskdata.Title + ' <i class="fa fa-pencil"></i></span>';
                floatingDiv += '                    <a onclick="export_project_csv($(this).data(\'projectid\'))" data-projectid=""  class="exportProject" id="exportProject" title="Export Project"><i class="fa fa-upload" aria-hidden="true"></i></a>';
                floatingDiv += '                    <a onclick="fun_delTodo('+projectID+',\''+viewtype+'\')" style="right: -30px;" class="exportProject"><i class="fa fa-trash" aria-hidden="true"></i> </a>';
                floatingDiv += '                    <i class="fa fa-close exportProject" aria-hidden="true" onClick="gotTasklist('+projectID+')" style="color: red;right: -1px;margin-left: 0px;cursor: pointer; margin-top: 0px;padding-top: 5px;"></i>';
                ...
                floatingDiv +='                 </span>';
                floatingDiv += '            </div>';
                floatingDiv += '            <div class="panel-body" style="padding-top: 0px;">'+propertiesTabsOne(projectID,viewtype,projectID,data,data)+'</div>';
                floatingDiv += '        </div>';
                floatingDiv += '    </div>';
                floatingDiv += '</div>';
    ...
    <script type="text/javascript">
        ...
        function openAttach(projectID,attr) {
            ...
            var floatingDiv =  ' <div data-attr="'+attr+projectID+'" id="backDiv'+attr+projectID+'"><div id="Pro'+projectID+'">';
                ...
                floatingDiv += '                <span style="width:100%;float: left;line-height: 1.5;text-overflow: ellipsis;    margin-top: -8px;font-size: 17px;font-family: NavigateFont;" class="project-text-propN"  id="comAttachame'+projectID+'"></span>';
                floatingDiv += '                    <i class="fa fa-close exportProject" aria-hidden="true" onClick="gotTasklist('+projectID+')" style="position: absolute; color: red; right: -1px;  cursor: pointer; padding-top: 5px; right: -64px; top: -12px;"></i>';
            ...
            $("#comAttachame"+projectID).text("Files on "+$("#pronameSpan").text());
        ...
        function openComments(projectID,attr,data){
            var floatingDiv =  ' <div  data-attr="'+attr+projectID+'" id="backDiv'+attr+projectID+'"><div id="Pro'+projectID+'">';
                ...
                floatingDiv += '                <span style="width:100%;float: left;line-height: 1.5;text-overflow: ellipsis;margin-top: -5px;font-size: 17px;font-weight: normal;font-family: NavigateFont;" class="project-text-propN" id="comProname'+projectID+'"></span>';
                ...
                floatingDiv += '                  <li class="ddm-com-set" style="display:inline">'
                            + '                     <a class="dropdown-toggle dt-com-set exportProject" data-toggle="dropdown"><img class="" src="' + base_url + '/asset/img/feedIcon/settings.png" style="margin-left: -4px;margin-top: -3px;"></a>'
                            ...
                            + '                      </ul>'
                            + '                     </li>';
                floatingDiv += '                    <i class="fa fa-close exportProject" aria-hidden="true" onClick="gotTasklist('+projectID+')" style="position: absolute; color: red; right: -1px;  cursor: pointer; padding-top: 5px; right: -98px; top: -12px;"></i>';
                floatingDiv += '            </span>';
                //floatingDiv += '            <a href="javascript:void(0);" onClick="CloseFlotDiv()" class="col-lg-1 proClBtn"><i class="fa fa-times"></i></a>';
                floatingDiv += '        </div>';
                ...
                $("#comProname"+projectID).text("Conversations on "+$("#pronameSpan").text());
        ...
        function setProjectAttribute(data){
            ...
            $.each(data.projects, function (key, value) {
                ...
                if(data.projects[key].importLevel == 0){
                    $("#myProjectOriginal").append(projectitem);
                }else{
    ...
    <script type="text/javascript">
        ...
        function propertiesTabsOne(projectid,viewtype,parentID,taskdata,data){
            ...
            tabDetail +='    <div class="row attachListDiv" id="attachListDivCommnet" style="min-height: 469px !important;">';
            ...
            tabDetail +='    </div>';
            tabDetail +='   <div class="taskComments" style="width: 96.5%;left: 13px;">';
            tabDetail +='       <div id="commentinput" onfocus="if($(this).html() == \'Type a message...\') $(this).html(\'\');expanTaskDiv()" onblur="if($(this).html() == \'\') $(this).html(\'Type a message...\');closeTaskDiv();" contenteditable data-status="ProjectCmnt" class="form-control commentinput commentinputClas'+projectid+'">Type a message...</div>';
            ...
            tabDetail +='           <a data-title="Attachment" data-toggle="lightbox" title="Attachment" href="'+base_url+'/projects/comattach/Project/'+projectid+'/ProjectsFiles">';
            tabDetail +='               <img src="'+base_url+'icons/attach.png" id="input_img2122">';
            tabDetail +='           </a>';
        ...
        function setCoMember(data,tagDivID){
            ...
            //     $("#projectcoowerspan"+tagDivID).append('<a style="margin-right: 2px;" href="javascript:void(0);" onmouseenter="qtipTaskByUser(this,'+tagDivID+',\''+remainingUserArray+'\',3)" class="btn btn-primary btn-circle tagAdBtn">+'+remainingNum+'</a>');
            // }else{
        ...
        function setCoOwner(data,tagDivID){
            ...
            //     $("#tagBtnDivCOADMIN"+tagDivID).append('<a style="margin-right: 2px;" href="javascript:void(0);" onmouseenter="qtipTaskByUser(this,'+tagDivID+',\''+remainingUserArray+'\',3)" class="btn btn-primary btn-circle tagAdBtn">+'+remainingNum+'</a>');
            // }else{
        ...
        function drawTaskList(data,status){
            ...
            if(data.allTask.length > 0){
                ...
                $.each(data.allTask, function (i, item) {
                    ...
                    taskDetailStr += '              <div class="btn-group"><span class="span3" style="margin-left: 0%;"><span class="duSpan dropdown-toggle pointer" aria-hidden="true" data-toggle="dropdown" aria-haspopup="true"><span data-toggle="tooltip" data-placement="bottom" title="Your tooltip is empty.">Due by : <span id="dueDateSpan' + item.Id + '" style="color:'+vColor+';">'+EnddateC+' </span></span></span>|';
                    taskDetailStr += '                 <div class="dropdown-menu cogs_set">';
                    taskDetailStr += '                      <div class="arrowtr"></div>';
                    taskDetailStr += '                      <div class="clipHead">SET TIMELINE & HOURS: <a href="#" title="This is some information for our tooltip." class="tooltipNee tips"><span title="More"><i class="fa fa-question-circle helpTips"></i></span><i class="fa fa-times-circle cCcloeSS"></i></a></div>';
                    ...
                    taskDetailStr += '              <div class="btn-group btngrp"><span data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle pointer" aria-hidden="true" id="hrCogBtn'+item.Id+'" style="margin-right: 6px;-webkit-box-shadow: none;box-shadow: none;"><span class="duSpan" data-toggle="tooltip" data-placement="bottom" title="Your tooltip for Hours req."> Hours req.: <span style="color:'+HourColor+'">'+endcColorS+'</span> </span></span>|';
                    taskDetailStr += '                  <div class="dropdown-menu cogs_set" style="width: 270px;height: 140px;">';
                    taskDetailStr += '                      <div class="arrowtr"></div>';
                    taskDetailStr += '                      <div class="clipHead">SET REQUIRED HOURS:  <a href="#" title="This is some information for our tooltip." class="tooltipNee tips"><span title="More"><i class="fa fa-question-circle helpTips"></i></span><i class="fa fa-times-circle cCcloeSS"></i></a></div>';
                    ...
                    taskDetailStr += '                  </div>';
                    taskDetailStr += '              </div>';
                    taskDetailStr += '              <span data-toggle="tooltip" data-placement="bottom" title="Your tooltip for status." style="z-index: 100;position: relative;" class="duSpan"><span clas="link_status_text'+item.Id+'  dt-todostatus" id="Levopenstatus'+item.Id+'" data-type="'+item.Type+'" data-serial="'+item.Id+'" data-status="'+item.Status+'" > Status:</span> <span  class="link_status_text'+item.Id+'  dt-todostatus deleteStatus" id="openstatus'+item.Id+'" data-type="'+item.Type+'" data-serial="'+item.Id+'" data-status="'+item.Status+'" >'+item.Status+'</span> </span>|<span data-toggle="tooltip" data-placement="bottom" title="Your tooltip for Assigned To ." onClick="userListTask(this,' + item.Id + ')"  class="duSpan">Assigned To:<span style="margin-top: -3px;position: relative;margin-left: 0%;" class="taskTagBtnDiv" id="tagBtnDiv'+item.Id+'"></span> </span>';
                    ...
                    taskDetailStr += '          <span class=""><i class="fa fa-share-alt hvr-glow clasI open_newpro1 cHover" aria-hidden="true" id="" title="Share This Task" style="position: relative;left: -20px;border-color: #ffffff;color: #ffffff;" onclick="SendInvite(\'Task\','+item.Id+');"></i><i style="border-color: #ffffff;color: #ffffff;" class="fa fa-plus hvr-glow clasI cHover open_newpro1" aria-hidden="true" id="projectbtn" title="Create Subtask" onclick="openInput('+item.Id+')"></i></span><i class="fa fa-ellipsis-h hvr-glow clasI" id="openQtipProperty' + item.Id + '" style="position: relative;margin-top: 1%; right: -25%;" title="Task Properties"></i>';
                    taskDetailStr += '      </div>';
                    taskDetailStr += '    </div>';
                ...
                if(data.allTasklist.length > 0 && data.allTask.length == 0){
                    ...
                    design += '     <a id="open_newpro1" onclick="$(\'#newTaskInput\').focus()" style="    position:relative;margin-left: 31%;margin-top: 4%;background: #686868 !important;border: 1px solid;" href="javascript:void(0);" class="btn btn-primary btn-lg">CREATE A TASK</a>';
                    $("#taskInsertDiv").append(design);
                }
            }
        ...
        function SendInvite(type,typeID){
            ...
            $(".taskDiv ").append(inviteFunction(type,typeID));

        }

        function inviteFunction(type,typeID){
            var inviteDiv  = '          <div id="inviteeDiv"> <div class="panel-body">'; 
                inviteDiv += '              <fieldset>';
                inviteDiv += '              <i class="fa fa-share-alt hvr-glow clasI" aria-hidden="true" id="" style="position: absolute; left: 23px; top: -25px;" data-hasqtip="676" oldtitle="Share This Task" title="" aria-describedby="qtip-676"></i> <span class="toptitle">'+$("#tasktext"+typeID).text()+'</span>';
                inviteDiv += '                  <legend>&nbsp;</legend>';
                ...
                inviteDiv += '                          <span class="inviteeLevel">Invitee Email :</span><span id="add_pencileIN"><img src="'+base_url+'asset/img/animate_pencil/pencil.gif" id="imghide" alt="img" width="15px" height="25px"></span><input class="form-control" type="text" id="inviteeEmail"><span class="highlight"></span><span class="bar"></span><label>Invitee Email</label>';
                inviteDiv += '                      </div>';
                inviteDiv += '                  </div>';
                inviteDiv += '                  <div class="smart-form form-group" style="margin-left: 1%;">';
                // inviteDiv += '                      <label class="col-md-2 control-label">Select Template :</label>';
                inviteDiv += '                      <div class="inline-group col-md-10 marginbtn">';
                inviteDiv += '                          <label class="radio">';
                inviteDiv += '                              <input type="radio" name="radio-inline" checked="checked">';
                inviteDiv += '                              <i></i>Textbox</label>';
                inviteDiv += '                          <label class="radio">';
                inviteDiv += '                              <input type="radio" name="radio-inline">';
                inviteDiv += '                              <i></i>Template</label>';
                inviteDiv += '                      </div>';
                inviteDiv += '                  </div>';
                inviteDiv += '                  <div class="form-group">';
                // inviteDiv += '                      <label class="col-md-2 control-label inviteeTextarea">Textarea</label>';
                inviteDiv += '                      <div class="col-md-12 marginbtn" id="animateTextarea">';
                inviteDiv += '                          <span class="inviteeTextarea">Textarea :</span><span id="add_pencileINText"><img src="'+base_url+'asset/img/animate_pencil/pencil.gif" id="imghide" alt="img" width="15px" height="25px"></span><div class="form-control" style="height: 277px; overflow-y: auto; padding-bottom: 10%;" id="inviteeTextare" rows="4" contenteditable="true"></div><span class="highlight"></span><label>Textarea</label>';
                inviteDiv += '                      </div>';
                inviteDiv += '                  </div>';
                inviteDiv += '              </fieldset>';         
                inviteDiv += '          </div>'; 
                ...
                inviteDiv += '              <footer>';
                inviteDiv += '                  <input type="hidden" id="shared_activity_id" value="'+typeID+'">';
                inviteDiv += '                  <input type="hidden" id="shared_activity_type" value="'+type+'">';
                        ...
                        if(projectId != "" && $("#newTaskInput").val() != ""){
                            $.ajax({
                                ...
                                success: function (data, textStatus) {
                                    ...
                                    taskDetailStr = '<div ondrop="drop(event)" ondragover="allowDrop(event)"  data-serial="'+data.taskInsertID+'" class="taskRow taskRowCus taskRow0604 bottom-border taskDetailDive taskserial'+data.taskInsertID+'  dt-todostatus" dt-sta="none" style="float: left;width:100%;border-left: 5px solid #ffffff;">';
                                    //icon Div Start
                                    
                                    taskDetailStr += '    <div style="width:100%;float:left;"  class="TtaskRow">';
                                    taskDetailStr += '      <div style="width:5%;float:left;">';
                                    taskDetailStr += '          <div class="icon-check iconGray garay"  onClick="makeComplete(' + data.taskInsertID + ',\'none\',\'Task\');" id="iconGray' + data.taskInsertID + '" style="display:block;" ></div>';
                                    taskDetailStr += '          <div class="icon-check iconGreen blue" onClick="makeComplete(' + data.taskInsertID + ',\'none\',\'Task\');" id="iconGreen' + data.taskInsertID + '" style="display:none;" ></div>'; 
                                    taskDetailStr += '      </div>';
                                    //Main Div Start
                                    taskDetailStr += '      <div style="width:86%;float:left;">';
                                    //Main Div Upper Start
                                    taskDetailStr += '          <div style="width:100%;">';
                                    taskDetailStr += '              <span data-serial="' + data.taskInsertID + '" id="tasktext' + data.taskInsertID + '" class="from proName clickontitle">' + $("#newTaskInput").val() + '</span>';
                                    
                                    taskDetailStr += '          </div>';
                                    //Main Div Lower Start
                                    taskDetailStr += '          <div style="width:100%;height: 25px;margin-top: 7px;margin-bottom: 7px;">';
                                    //Main Div Due By POPUP Start
                                    taskDetailStr += '              <div class="btn-group"><span class="span3" style="margin-left: 0%;"><span class="duSpan dropdown-toggle pointer" aria-hidden="true" data-toggle="dropdown" aria-haspopup="true"><span>Due by : <span style="color:RED;">[no due date] </span></span></span>|';
                                    taskDetailStr += '                 <div class="dropdown-menu cogs_set">';
                                    taskDetailStr += '                      <div class="arrowtr"></div>';
                                    taskDetailStr += '                      <div class="clipHead">SET TIMELINE & HOURS: <a href="#" title="This is some information for our tooltip." class="tooltipNee tips"><span title="More"><i class="fa fa-question-circle helpTips"></i></span><i class="fa fa-times-circle cCcloeSS"></i></a></div>';
                                    taskDetailStr += '                      <table width="100%;">';
                                    taskDetailStr += '                          <tr class="clipTr">';
                                    taskDetailStr += '                              <td style="width: 46%;">Due Date:</td>';
                                    taskDetailStr += '                              <td class="clipTD"><input onclick="togglecalendar_endPro(' + data.taskInsertID + ')" type="text" id="endDateinNew' + data.taskInsertID + '" style="width: 99%;color:RED;" name="mydate" class="datepicker taskDate customdate " data-dateformat="M d yy" value="[no due date]"><a href="#" title="This is some information for our tooltip." class="tooltipNee"><span title="More"><i class="fa fa-question-circle helpDue"></i></span></a>';
                                    taskDetailStr += '                              </td>';
                                    taskDetailStr += '                          </tr>';
                                    taskDetailStr += '                          <tr class="clipTr">';
                                    taskDetailStr += '                              <td style="width: 46%;">Duration (in days):';
                                    taskDetailStr += '                              </td>';
                                    taskDetailStr += '                              <td class="clipTD"><input type="text" style="width:100%;" class="duarationClass duSInput" onchange="getDuration($(this).data(\'id\'),' + data.taskInsertID + ',\'startDatein\')" data-id="duration' + data.taskInsertID + '" id="duration' + data.taskInsertID + '" value="0">';
                                    taskDetailStr += '                              </td>';
                                    taskDetailStr += '                          </tr>';
                                    taskDetailStr += '                          <tr class="clipTr">';
                                    taskDetailStr += '                              <td  style="width: 46%;">Start Date:';
                                    taskDetailStr += '                              </td>';
                                    taskDetailStr += '                              <td class="clipTD"><input onclick="togglecalendar_startPro(' + data.taskInsertID + ')" data-c = "1" type="text" id="startDatein' + data.taskInsertID + '" style="width: 99%;" name="mydate" class="datepicker customdate" data-dateformat="M d yy"  value="'+moment(data.startDate).format('MMM DD YYYY')+'"><a href="#" title="This is some information for our tooltip." class="tooltipNee"><span title="More"><i class="fa fa-question-circle helpDue"></i></span></a>';
                                    taskDetailStr += '                              </td>';
                                    taskDetailStr += '                          </tr>';
                                    taskDetailStr += '                      </table>';
                                    taskDetailStr += '                  </div>';
                                    taskDetailStr += '              </div>';
                                    //Main Div Hour POPUP Start
                                    taskDetailStr += '              <div class="btn-group btngrp"><span data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle pointer" aria-hidden="true" id="hrCogBtn'+data.taskInsertID+'" style="margin-right: 6px;-webkit-box-shadow: none;box-shadow: none;"><span class="duSpan"> Hours req.: <span style="color:RED;">[None]</span> </span></span>|';
                                    taskDetailStr += '                  <div class="dropdown-menu cogs_set" style="width: 270px;height: 140px;">';
                                    taskDetailStr += '                      <div class="arrowtr"></div>';
                                    taskDetailStr += '                      <div class="clipHead">SET REQUIRED HOURS:  <a href="#" title="This is some information for our tooltip." class="tooltipNee tips"><span title="More"><i class="fa fa-question-circle helpTips"></i></span><i class="fa fa-times-circle cCcloeSS"></i></a></div>';
                                    taskDetailStr += '                      <table width="100%;" style="margin-top: 11%;">';
                                    ...
                                    taskDetailStr += '                              <td style="width: 46%;">Duration (in hour):';
                                    taskDetailStr += '                              </td>';
                                    taskDetailStr += '                              <td class="clipTD" style="width: 33%;"><input type="text" style="color:RED;width:100%;" class="duarationClass duSInput hrCogBtn'+data.taskInsertID+'" onchange="getDurationhr($(this).data(\'id\'),' + data.taskInsertID + ',\'task\')" data-id="hrduration' + data.taskInsertID + '" id="hrduration' + data.taskInsertID + '" value="[None]">';
                                    taskDetailStr += '                              </td>';
                                    taskDetailStr += '                          </tr>';
                                    taskDetailStr += '                      </table>';
                                    taskDetailStr += '                  </div>';
                                    taskDetailStr += '              </div>';
                                    taskDetailStr += '              <span  style="z-index: 100;position: relative;" class="duSpan"><span clas="link_status_text'+data.taskInsertID+'  dt-todostatus" id="Levopenstatus'+data.taskInsertID+'" data-type="Task" data-serial="'+data.taskInsertID+'" data-status="none" > Status:</span> <span class="link_status_text'+data.taskInsertID+'  dt-todostatus deleteStatus" id="openstatus'+data.taskInsertID+'" data-type="Task" data-serial="'+data.taskInsertID+'" data-status="none" style="color:RED;"">[ none ]</span> </span>|<span data-toggle="tooltip" data-placement="bottom" title="Your tooltip for Assigned To."  onClick="userListTask(this,' + data.taskInsertID + ')"  class="duSpan">Assigned To: <span style="margin-top: -3px;position: relative;margin-left: 0%;" class="taskTagBtnDiv" id="tagBtnDiv'+data.taskInsertID+'"></span> </span>';
                                    //taskDetailStr += '              | <span style="z-index: 100;position: relative;" id="subTaskcountbtn' + data.taskInsertID + '" class="duSpan subTaskcountbtn"><span>Subtask:</span><span id="subTaskcountbtnValue' + data.taskInsertID + '" style="padding-right: 7px;"></span></span>';
                                    taskDetailStr += '          </div>';
                                    taskDetailStr += '      </div>';
                                    //Right Div Start
                                    taskDetailStr += '      <div style="width:9%;float:left;margin-top: 1%;">';
                                    // taskDetailStr += '          <div id="subTaskcountbtnValue' + item.Id + '" style="float:left;width: 49%;margin-top: 15%;" ></div>';
                                    taskDetailStr += '          <span class=""><i class="fa fa-share-alt hvr-glow clasI open_newpro1 cHover" aria-hidden="true" id="" title="Share This Task" style="position: relative;left: -20px;border-color: #ffffff;color: #ffffff;" onclick="SendInvite(\'Task\','+data.taskInsertID+');"></i><i class="fa fa-plus hvr-glow clasI open_newpro1 cHover" aria-hidden="true" style="position: absolute; right: 9.4%;border-color: #ffffff; color: #ffffff;" id="projectbtn" title="Create Subtask" onclick="openInput('+data.taskInsertID+')"></i><i class="fa fa-ellipsis-h hvr-glow clasI" id="openQtipProperty' + data.taskInsertID + '" style="position: relative;margin-top: 1%; right: -42%;" title="Task Properties"></i></span>';
                                    taskDetailStr += '      </div>';
                                    taskDetailStr += '    </div>';
                                    taskDetailStr += '    <div style="width:100%;float:left;">';
                                    ...
                                    $('#openQtipProperty'+data.taskInsertID).click(function(){
                                         qtipPropertiesProject(this,data,'Task');
                                    });
                                    ...
                                    // fun_loadfulltable($("#newTaskInput").attr('data-projectid'),'DESC','NEW'); 
                ...
                success: function (data_st, textStatus) {
                    ...
                    if(data_st.allSubTask.length > 0){
                        $.each(data_st.allSubTask, function (index, value) {
                            ...
                            //Main Div Due By POPUP Start
                            subtaskList += '              <div class="btn-group"><span class="span3" style="margin-left: 0%;"><span class="duSpan dropdown-toggle pointer" aria-hidden="true" data-toggle="dropdown" aria-haspopup="true"><span data-toggle="tooltip" data-placement="bottom" title="Tooltip on top">Due by : <span id="dueDateSpan' + value.Id + '" style="color:'+vColor+';">'+EnddateC+' </span></span></span>|';
                            subtaskList += '                 <div class="dropdown-menu cogs_set">';
                            subtaskList += '                      <div class="arrowtr"></div>';
                            subtaskList += '                      <div class="clipHead">SET TIMELINE & HOURS: <a href="#" title="This is some information for our tooltip." class="tooltipNee tips"><span title="More"><i class="fa fa-question-circle helpTips"></i></span><i class="fa fa-times-circle cCcloeSS"></i></a></div>';
                            ...
                            subtaskList += '                  </div>';
                            subtaskList += '              </div>';
                            subtaskList += '              <div class="btn-group btngrp"><span data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle pointer" aria-hidden="true" id="hrCogBtn'+value.Id+'" style="margin-right: 6px;-webkit-box-shadow: none;box-shadow: none;"><span class="duSpan"> Hours req.: <span style="color:'+HourColor+'">'+endcColorS+'</span> </span></span>|';
                            subtaskList += '                  <div class="dropdown-menu cogs_set" style="width: 270px;height: 140px;">';
                            subtaskList += '                      <div class="arrowtr"></div>';
                            subtaskList += '                      <div class="clipHead">SET REQUIRED HOURS:  <a href="#" title="This is some information for our tooltip." class="tooltipNee tips"><span title="More"><i class="fa fa-question-circle helpTips"></i></span><i class="fa fa-times-circle cCcloeSS"></i></a></div>';
                            subtaskList += '                      <table width="100%;" style="margin-top: 11%;">';
                            subtaskList += '                          <tr class="clipTr">';
                            subtaskList += '                              <td style="width: 46%;">Duration (in hour):';
                            subtaskList += '                              </td>';
                            subtaskList += '                              <td class="clipTD" style="width: 33%;"><input type="text" style="color:'+HourColor+';width:100%;" class="duarationClass duSInput hrCogBtn'+value.Id+'" onchange="getDurationhr($(this).data(\'id\'),' + value.Id + ',\'subtask\')" data-id="hrduration' + value.Id + '" id="hrduration' + value.Id + '" value="'+endcColorS+'">';
                            subtaskList += '                              </td>';
                            subtaskList += '                          </tr>';
                            subtaskList += '                      </table>';
                            subtaskList += '                  </div>';
                            subtaskList += '              </div>';
                            subtaskList += '              <span style="z-index: 100;position: relative;" class="duSpan"><span clas="link_status_text'+value.Id+'  dt-todostatus" id="Levopenstatus'+value.Id+'" data-type="'+value.Type+'" data-serial="'+value.Id+'" data-status="'+value.Status+'" > Status:</span> <span class="link_status_text'+value.Id+'  dt-todostatus deleteStatus" id="openstatus'+value.Id+'" data-type="'+value.Type+'" data-serial="'+value.Id+'" data-status="'+value.Status+'" >'+value.Status+'</span> </span>|<span onClick="userListTask(this,' + value.Id + ')"  class="duSpan">Assigned To: <span style="margin-top: -3px;position: relative;margin-left: 0%;" class="taskTagBtnDiv" id="tagBtnDiv'+value.Id+'"></span></span> ';
                            subtaskList += '          </div>';
                            subtaskList += '      </div>';
                            //Right Div Start
                            subtaskList += '      <div style="width:7%;float:left;margin-top: 1%;">';
                            // taskDetailStr += '          <div id="subTaskcountbtnValue' + item.Id + '" style="float:left;width: 49%;margin-top: 15%;" ></div>';
                            subtaskList += '                <div class="dropdownCus">'; 
                            subtaskList +='                     <i class="fa fa-share-alt hvr-glow clasI open_newpro1 cHover" aria-hidden="true" id="" title="Share This Subtask" onclick="SendInvite(\'Sub Task\','+value.Id+');" style="position: relative;left: -5px;top: 3px;border-color: #ffffff;color: #ffffff;"></i><i class="fa fa-ellipsis-h hvr-glow clasI " id="properties'+value.Id+'" style="float: right;margin-top: 8%;position: relative;right: -14px;"></i>';
                        ...
                        show: function(event, api) {
                            ...
                            requestass.done(function(data){
                                ...
                                var floatingDiv =  '<div data-attr="'+viewtype+projectID+'" id="backDiv'+viewtype+projectID+'">';
                                    ...
                                    floatingDiv +='                     </div>';
                                    floatingDiv +='                     <div><a class="dropdown-toggle procopyIMG hvr-glow clasI" data-toggle="dropdown"><img style="width: 107% !important;" src="'+base_url+'icons/proCopy.png"></a>';
                                ...
                                $('#todo_name_text'+projectID).html(data.detail[0].Title + ' <i class="fa fa-pencil"></i>');
