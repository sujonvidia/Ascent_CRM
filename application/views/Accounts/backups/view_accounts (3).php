 ...
 //    		if(str.indexOf(key) > -1){
	...
	function drawDiv(datadiv){
		...
		str +='<div class="row"  style="padding:5px;cursor: pointer;">';
			...
			str +='<span style="color:#6E777B;font-size:large;font-weight: bold">'+datadiv.accountname+'</span>';
			str +='</div>';
		...
		str +='<div class="col-lg-12" style="border-bottom-style: groove;padding-bottom: 5px;">';
			...
			str +='<span class="div-data-info" style="color:black;display:block;"><b>Phone: </b> '+datadiv.phone+', </span>';
			str +='<span class="div-data-info" style="color:black;display:block;"><b>Email: </b><a href="mailto:'+datadiv.email1+'">'+datadiv.email1+'</a>, </span>'; 
			str +='<span class="div-data-info" style="color:black;display:block;"><b>Website: </b><a target="_blank" href="'+datadiv.website+'">'+datadiv.website+'</a></span>';
			str +='</div>';
		str +='</div>';
		str+='</div>';
		// third row
