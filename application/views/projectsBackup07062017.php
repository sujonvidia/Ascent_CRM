            ...
            <ol class="breadcrumb">
                <li style="text-align: center;color: #474544;">
                    ...
                    <ul class="list-inline ribUl" id="ribUl">
                      ...
                      <ol class="ribLi noBorder ribLi2" data-type="comments" id="" data-projectid=""><i class="fa fa-comments-o" aria-hidden="true"  style="color: #ff5e00;font-size: 15px;"></i> Conversations</ol>
...
function  removethis(inputID,imgName,taskid,type){
    ...
    <script type="text/javascript">
        ...
        // $("div").delegate('.logView','click',function(e){
        //     e.stopImmediatePropagation();
        //     var id = e.target.id;
        ...
        function openProperties(projectID,attr,viewtype,data){
            ...
            var floatingDiv =  '<div data-attr="'+attr+projectID+'" id="backDiv'+attr+projectID+'">';
                ...
                floatingDiv += '                    <a style="position: absolute; right: 129px; top: 34px;" onclick="logView()" data-projectid=""  class="exportProject" id="exportProject" title="View Log"><i class="fa fa-shield" aria-hidden="true" style="margin-top: 4px; margin-left: 1px;"></i></a>';
                floatingDiv += '                    <a style="position: absolute; right: 95px; top: 34px;" onclick="export_project_csv($(this).data(\'projectid\'))" data-projectid="'+projectID+'"  class="exportProject" id="exportProject" title="Export Project"><i class="fa fa-upload" aria-hidden="true"></i></a>';
                floatingDiv += '                    <a  onclick="fun_delTodo('+projectID+',\''+viewtype+'\')" style="position: absolute; right: 62px; top: 34px;" class="exportProject"><i class="fa fa-trash" aria-hidden="true"></i> </a>';
                floatingDiv += '                    <i class="fa fa-close exportProject" aria-hidden="true" onClick="gotTasklist('+projectID+')" style="position:absolute;top: 34px;color: red;right: 29px;margin-left: 0px;cursor: pointer; margin-top: 0px;padding-top: 5px;"></i>';
        ...
        function taskPropetritesOpen(element,maindata,viewtype){
            ...
            requestass.done(function(data){
                ...
                var floatingDiv =  '<div data-attr="'+viewtype+projectID+'" id="backDiv'+viewtype+projectID+'">';
                    ...
                    floatingDiv +='                         <span class="pull-right filter" style="position: absolute; right: 116px; top: 8px;"><i class="fa fa-paperclip hvr-glow clasI customTaskImg" aria-hidden="true" data-type="attach" id="comAttahID" onclick="attacher()"></i></span>';
                    floatingDiv +='                     </div>';
                    floatingDiv +='                     <div><a class="dropdown-toggle procopyIMG hvr-glow clasI" data-toggle="dropdown" style="position: absolute; right: 106px; top: 40px;"><img style="width: 107% !important;margin-top: -200%;" src="'+base_url+'icons/proCopy.png"></a>';
        ...
        function drawTaskList(data,status){
            ...
            if(data.allTask.length > 0){
                ...
                if($("#rarrow").is(":visible")){
                    ...
                    // $(".ribLi").removeClass('activeOL');
                    // $("#listIMG"+proid).addClass('activeOL');
                    // $(".inviteClose").hide();
                    // $('#reportDivArea').hide();
                    // $('#rarrow').hide();    
                    // $('#larrrow').show();   
    ...
    /////////////////////////////////////////////// Enter key press \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
                ...
                success: function (data_st, textStatus) {
                    ...
                    if(data_st.allSubTask.length > 0){
                        $.each(data_st.allSubTask, function (index, value) {
                            ...
                            if(value.isShared == '1'){
                                shareBtnNew = '| <span onclick="qtipSharedOnclick(\'Sub Task\','+value.Id+',\'subtasktitle\')" onmouseenter="qtipSharedBox(this,'+value.Id+')" id="openShared'+value.Id+'" data-toggle="tooltip" data-placement="top"><i class="fa fa-share-alt" aria-hidden="true" style="margin: 8px;"></i></span>';
                            }else{
                                shareBtnNew = '';
                            }

                            subtaskList ='       <div class="col-lg-12" style="margin-bottom: 3px;">';
                            ...
                            subtaskList += '             <i class="fa fa-check iconGray"  onClick="makeComplete(' + value.Id + ',\''+value.Status+'\',\'SubTask\');" id="iconGray' + value.Id + '" style="display:'+sty2+';" ></i>';
                            subtaskList += '             <i class="fa fa-check iconGreen" onClick="makeComplete(' + value.Id + ',\''+value.Status+'\',\'SubTask\');" id="iconGreen' + value.Id + '" style="display:'+sty1+';" ></i>';  
                            subtaskList += '      </div>';
                            //Main Div Start
                            ...
                            //Main Div Due By POPUP Start
                            subtaskList += '              <div class="btn-group"><span class="span3" style="margin-left: 0%;"><span class="duSpan dropdown-toggle pointer" aria-hidden="true" data-toggle="dropdown" aria-haspopup="true"><span data-toggle="tooltip" data-placement="top" title="SET TIMELINE"><i class="fa fa-calendar" aria-hidden="true"></i> <span id="dueDateSpan' + value.Id + '" style="color:'+vColor+';">'+EnddateC+' </span></span></span>|';
                            subtaskList += '                 <div class="dropdown-menu cogs_set">';
                            subtaskList += '                      <div class="arrowtr"></div>';
                            subtaskList += '                      <div class="clipHead">SET TIMELINE : <a href="#" title="This is some information for our tooltip." class="tooltipNee tips"><i class="fa fa-question-circle helpTips"></i><i class="fa fa-times-circle cCcloeSS"></i></a></div>';
                            subtaskList += '                      <table width="100%;">';
                            subtaskList += '                        <tr class="clipTr">';
                            subtaskList += '                            <td style="width: 46%;">Due Date:</td>';
                            subtaskList += '                            <td class="clipTD"><input type="text" onclick="togsubcalend(' + value.Id + ')" id="SubendDateinNew' + value.Id + '" style="width:99%;color:'+vColor+';" name="mydate" class="datepicker subtaskDatePicker customdate" data-dateformat="M d yy" value="'+EnddateC+'"><a href="#" ><i class="fa fa-question-circle helpDue"  data-toggle="tooltip" data-placement="top" title="HELP TOOLTIP"></i></a>';
                            subtaskList += '                            </td>';
                            subtaskList += '                        </tr>';
                            subtaskList += '                        <tr class="clipTr">';
                            ...
                            subtaskList += '                            </td>';
                            subtaskList += '                            <td class="clipTD"><input type="text" style="width:99%;" id="SubstartDatein' + value.Id + '" onclick="togsubcalstart(' + value.Id + ')" name="" class="datepicker customdate" data-dateformat="M d yy"  value="'+moment(value.Startdate).format('MMM DD YYYY')+'"><a href="#"><i class="fa fa-question-circle helpDue"  data-toggle="tooltip" data-placement="top" title="HELP TOOLTIP"></i></a>';
                            subtaskList += '                            </td>';
                            subtaskList += '                        </tr>';
                            subtaskList += '                    </table>';
                            subtaskList += '                  </div>';
                            subtaskList += '              </div>';
                            subtaskList += '              <div class="btn-group btngrp"><span data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle pointer" aria-hidden="true" id="hrCogBtn'+value.Id+'" style="margin-right: 6px;-webkit-box-shadow: none;box-shadow: none;"><span class="duSpan" data-toggle="tooltip" data-placement="top" title="SET REQUIRED HOURS"> <i class="fa fa-clock-o" aria-hidden="true" style="margin-right: 5px;margin-top: 3px;font-size: 15px;"></i> <span style="color:'+HourColor+'">'+endcColorS+'</span> </span></span>|';
                            ...
                            subtaskList += '                  </div>';
                            subtaskList += '              </div>';
                            subtaskList += '              <span style="z-index: 100;position: relative;" class="duSpan"  data-toggle="tooltip" data-placement="top" title="SET STATUS"><span clas="link_status_text'+value.Id+'  dt-todostatus" id="Levopenstatus'+value.Id+'" data-type="'+value.Type+'" data-serial="'+value.Id+'" data-status="'+value.Status+'" > <i class="fa fa-bullhorn" aria-hidden="true" style="font-size: 15px;margin-right: 5px;margin-top: 3px;"></i> </span> <span class="link_status_text'+value.Id+'  dt-todostatus deleteStatus" id="openstatus'+value.Id+'" data-type="'+value.Type+'" data-serial="'+value.Id+'" data-status="'+value.Status+'" >'+value.Status+'</span> </span>|<span onClick="userListTask(this,' + value.Id + ')"  class="duSpan" data-toggle="tooltip" data-placement="top" title="SET ASSIGNEE"><i class="fa fa-user" style="font-size: 15px;margin-right: 5px;margin-top: 3px;" aria-hidden="true"></i> <span style="margin-top: -3px;position: relative;margin-left: 0%;" class="taskTagBtnDiv" id="tagBtnDiv'+value.Id+'"></span></span> '+shareBtnNew;
                            subtaskList += '          </div>';
                            subtaskList += '      </div>';
                            //Right Div Start
                            ...
                            subtaskList +='                     <i style="margin-right: 24px; margin-left: -49px; margin-top: 4px;border-color: #ffffff;color: #ffffff;" class="fa fa-plus hvr-glow clasI cHover open_newpro1" aria-hidden="true" id="projectbtn" title="Add Sub Task" onclick="openSubIn('+value.Id+')"></i><i class="fa fa-share-alt hvr-glow clasI open_newpro1 cHover" aria-hidden="true" id="" title="Share This Subtask" onclick="SendInvite(\'Sub Task\','+value.Id+',\'subtasktitle\');" style="position: relative;left: -5px;top: 1px;border-color: #ffffff;color: #ffffff;"></i><i class="fa fa-ellipsis-h hvr-glow clasI cHover" id="SubopenQtipProperty' + value.Id + '" style="float: right;margin-top: 8%;position: relative;right: -14px;border-color: #ffffff;color: #ffffff;"></i>';
        ...
        function propertiesProjecttab(projectid,viewtype,parentID,taskdata,data){
            ...
            // tabDetail +='    <div style="border-top: 1px solid #e0dddd;margin-top: 6.5%;width: 96%;margin-left: 2%;">&nbsp;</div>';
            tabDetail +='       <div id="commentinput" onfocus="if($(this).html() == \'Type a message...\') $(this).html(\'\');expanTaskDivNEW();" onblur="if($(this).html() == \'\') $(this).html(\'Type a message...\');closeTaskDivNEW();" contenteditable data-status="TaskCmnt" class="form-control commentinput">Type a status...</div>';
