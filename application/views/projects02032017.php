...
<body id="projectBody" class="<?php echo ($page_style_result == 0)?"hidden-menu":""; ?>">
                                                ...
                                                <div class="col-lg-12 col-sm-12 col-md-12">
                                                   ...
                                                   <!--  <i class="fa fa-caret-up" id="sortUP" onclick="changeViewOrder()"></i>
                                                    ...
                                                    <ul class="dropdown-menu dropdown-change-view pull-right">
                                                        ...
                                                        <li><a><i class="fa fa-check whiteClr"></i>Incompleted Tasks</a></li>
	...
	<script>
        $('ul.dropdown-change-view li').click(function(e){ 
            ...
            }else if($(this).text()=='Incompleted Tasks'){
        ...
        function changeViewOrder(){
            ...
            if($('#DueDateOrder').text() == "DESC"){
                ...
                if($("#DueDateText").text() == 'Completed Tasks' || $("#DueDateText").text() == 'Incompleted Tasks'){
...
function  removethis(inputID,imgName,taskid,type){
	...
	<script type="text/javascript">
        ...
        function openProperties(projectID,attr){
            ...
            //         var now = moment(this.value); 
            //         var end = moment($("#projectendtDate"+projectID).val()); 

            //         var duration = moment.duration(end.diff(now));
            //         var days = duration.asDays();
                    
            //         var sel_date = moment(this.value).add(days, 'days').format('YYYY-MM-DD HH:mm:ss');
	...
	<script type="text/javascript">
        ...
        function tags(data,tagDivID){
            ...
            if(totalMember > 3){
                ...
                for(var i = 0;i < 3;i++){
                    ...
                    $("#tagBtnDivTag"+tagDivID).append('<a title="'+tagUserArray[i]+'" style="margin-right: 2px;" href="javascript:void(0);" class="btn btn-primary btn-circle">'+acronym+'</a>');
                }

                // $("#tagBtnDiv").append('<a style="margin-right: 2px;" href="javascript:void(0);" class="btn btn-primary btn-circle">+'+remainingNum+'</a>');
                $("#tagBtnDivTag"+tagDivID).append('<a style="margin-right: 2px;" href="javascript:void(0);" class="btn btn-primary btn-circle">+'+remainingNum+'</a>');
		...
		function drawTaskList(data,status){
            ...
            console.log(data);
            console.log(data.allTasklist.length);
            ...
            var dateArr = [];
                ...
                if(data.allTask.length > 0){
                    ...
                    $.each(data.allTask, function (i, item) {
                            ...
                            taskDetailStr += '              <div  class="row bottom-border taskDetailDive taskserial'+item.Id+' dt-todostatus" dt-sta="'+item.Status+'" style="border-left: 5px solid '+blcol+';">';
                            taskDetailStr += '                  <div class="col-lg-9 col-sm-9 col-md-9 taskRow" style="width:72%;margin-bottom:-1%;"> ';                  
                            taskDetailStr += '                      <div class="col-lg-1">';
                            taskDetailStr += '                          <div class="row text-center">';
                            taskDetailStr += '                              <img class="icon-check iconGray"  onClick="makeComplete(' + item.Id + ',\''+item.Status+'\');" id="iconGray' + item.Id + '" style="display:'+sty2+';" src="icons/CheckmarkGray.png">';
                            taskDetailStr += '                              <img class="icon-check iconGreen" onClick="makeComplete(' + item.Id + ',\''+item.Status+'\');" id="iconGreen' + item.Id + '" style="display:'+sty1+';" src="icons/CheckmarkGreean.png">';                      
                            taskDetailStr += '                          </div>';
                            taskDetailStr += '                          <div class="row" id="subTaskcountbtnValue' + item.Id + '">';
                            taskDetailStr += '                          </div>';
                            taskDetailStr += '                      </div>';
                            taskDetailStr += '                      <div class="col-lg-11">';
                            taskDetailStr += '                          <span onClick="makeActive(' + item.Id + ')" id="taskdestext' + item.Id + '" class="from proName">' + item.Title + '</span>';                    
                            taskDetailStr += '                          <p class="name">';                          
                            taskDetailStr += '                              <span class="span1">Start Date: <input onclick="togglecalendar_startPro(' + item.Id + ',$(this).data(\'c\'))" data-c = "1" type="text" id="startDatein' + item.Id + '" name="mydate" class="datepicker customdate" data-dateformat="M d yy"  value="'+moment(item.Startdate).format('MMM DD YYYY')+'"></span>';
                            ...
                            taskDetailStr += '                              <span class="span3" style="margin-left: 12%;">End Date: <input onclick="togglecalendar_endPro(' + item.Id + ')" type="text" id="endDatein' + item.Id + '" name="mydate" class="datepicker customdate" data-dateformat="M d yy" value="'+moment(item.Enddate).format('MMM DD YYYY')+'"></span>';                 
                            taskDetailStr += '                          </p>';
                            taskDetailStr += '                      </div>';    
                            taskDetailStr += '                  </div>';
                            taskDetailStr += '                  <div class="col-lg-3 col-sm-3 col-md-3 imgRow"  style="width:28%">';
                            ...
                            taskDetailStr += '                          <img data-toggle="tooltip" data-placement="bottom" title="Chat" onClick="qtipComment(this, ' + item.Id + ')" class="icon-todo-menu" src="icons/Chat.png"><span class="tipT" id="tipTT'+item.Id+'">'+uCc+'</span>';
                           ...
                           var fpstart= flatpickr("#startDatein"+item.Id, {
                            ...
                            DrawSubTaskList(item.HasParentId,item.Id);
                        });
        ...
        function openInput(value){
            ...
            if($("#newsubTaskInput"+value).is(':visible') && totaltask == 0){
                ...
                $("#subTaskInputDiv"+value).show('slow');
                $("#newsubTaskInput"+value).show('slow');
                $("#subTaskcountbtn"+value+"DIV").show('slow');
  ...
  //   }
	...
	<script type="text/javascript">
        ...
        function checkCokie(){
	        ...
	        if(getCookie('project') != 0){
                ...
                console.log("Gety:"+getCookie('ClickType'));
    ...
    //             fun_loadfulltable(targetProjectId);
				// fun_loadfulltable(targetProjectId);
                fun_loadfulltable(targetProjectId,'DESC');
	    	...
	    	$.ajax({
                ...
                success: function (data_st, textStatus) {
                    ...
                    $.each(data_st.allSubTask, function (index, value) {
                        ...
                        subtaskList = '	    <div class="row bottom-border subtaskDetailDive" id="subtaskDetailDive'+value.Id+'">';				
						...
						subtaskList +='				</div>';
						subtaskList +='				<div class="col-lg-11">';
						subtaskList +='					<span onClick="makeActive2('+value.Id+')" class="from" id="subtasktitle'+value.Id+'">'+ value.Title +'</span>';						
						subtaskList += '				<p class="name" style="margin-bottom:0px;">';							
						subtaskList += '					<span class="span1">Start Date: <input type="text" id="SubstartDatein' + value.Id + '" onclick="togsubcalstart(' + value.Id + ')" name="" class="datepicker customdate" data-dateformat="M d yy"  value="'+moment(value.Startdate).format('MMM DD YYYY')+'"></span>';
						...
						subtaskList += '					<span style="margin-left: 12%;">End Date: <input type="text" onclick="togsubcalend(' + value.Id + ')" id="SubendDatein' + value.Id + '" name="mydate" class="datepicker customdate" data-dateformat="M d yy" value="'+moment(value.Enddate).format('MMM DD YYYY')+'"></span>';					
						subtaskList += '				</p>';
						subtaskList +='				</div>';	
						subtaskList +='			</div>';					
						...
						subtaskList +='					<img id="SubopenQtipProperty' + value.Id + '" class="icon-todo-menu" src="icons/Details_Properties.png">';							
						subtaskList +='				</div>';					
						subtaskList +='			</div>';
						subtaskList +='		</div>';
...
function togsubcalstart(serial){
    ...
    function togglecalendar_endPro(serial){
        ...
        // if(status == 1)
        //     $("#projectendtDate"+serial).data('c',2);
        // else
