									...
									<table class="table table-striped table-bordered table-hover profile_list_table bor-rad" id="report_table" style="width:100%">
										<thead>
											<tr>
												...
												<!-- <th id="report_headname" style="width: 15%">ID</th> -->
								...
								<div style="width: 50%;margin-left: 25%;border:1px solid #ccc;border-radius: 8px;margin-top: 5%;">
									<div class="panel panel-head">
										...
										<h3 class="no-float txt-color-blueDark">
											...
											<span><?php echo "Chatting Reports"; ?></span>
											...
											<div id="divReportType">
												<li>
													...
													<select onchange="changeReportTypeList(this)" class="select2 proInputText" id="report_type" name="report_type">
														...
														<option value="SubTask">SubTask Chat</option>
														<option value="Todo">To-Do Chat</option>
...
<script type="text/javascript">
	...
	function generatePreview(){
		...
		var request = $.ajax({
			url: base_url+"report/getReportChat",
			method: 'POST',
			data: {
				range: $('.cls-daterange .active a').text(),
		...
		request.done(function(response){
			...
			$('#report_body').empty();
			//$('#report_headname').text($('#report_type').val()+" Name");
			// var head_item = datatable.columns(4).header();
			// $(head_item ).html($('#report_type').val()+" Name");
			
			datatable.clear();
			$.each(response.data, function(k,v){
				
				
				datatable.row.add(insertNewReport(v,$('#report_type').val()));
