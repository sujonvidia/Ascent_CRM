                ...
                <ol class="breadcrumb">
                    <li style="text-align: center;color: #474544;">
                        ...
                        <div class="ViewDiv" id="customExportDiv">               
                            <span class="" data-toggle="dropdown" ><i class="fa fa-angle-down dropdown-toggle" aria-expanded="false"></i></span>             
                            <ul class="dropdown-menu pull-left viewUpdateTop">                    
                                <!-- <div class="arrow-top-right"></div>                  -->
                                <li onclick="export_project_csv($(this).data('projectid'))" data-projectid="" id="exportProject"><a href="javascript:void(0);"> Export</a></li>                   
                                <li onclick="fun_delUni($(this).data('projectid'))" data-projectid="" id="deleteProject"><a href="javascript:void(0);"> Delete Project</a></li>                 
                                <!-- <li onclick="filter('SA')"><a href="javascript:void(0);"> All</a></li>               -->
                            </ul>           
                        </div>
            ...
            var vColor = 'inherit';
                ...
                if(data.allTask.length > 0){
                    ...
                    $.each(data.allTask, function (i, item) {
                            ...
                            taskDetailStr += '              <div class="btn-group"><span class="span3" style="margin-left: 0%;"><span class="duSpan dropdown-toggle pointer" aria-hidden="true" data-toggle="dropdown" aria-haspopup="true"><span>Due by : <span style="color:'+vColor+';">'+EnddateC+' </span></span></span>|';
                            ...
                            taskDetailStr += '              <div class="btn-group btngrp"><span data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle pointer" aria-hidden="true" id="hrCogBtn'+item.Id+'" style="margin-right: 6px;-webkit-box-shadow: none;box-shadow: none;"><span class="duSpan"> Hours req.: <span style="color:'+HourColor+'">'+endcColorS+'</span> </span></span>|';
                ...
                success: function (data_st, textStatus) {
                    ...
                    if(data_st.allSubTask.length > 0){
                        $.each(data_st.allSubTask, function (index, value) {
                            ...
                            //Main Div Due By POPUP Start
                            subtaskList += '              <div class="btn-group"><span class="span3" style="margin-left: 0%;"><span class="duSpan dropdown-toggle pointer" aria-hidden="true" data-toggle="dropdown" aria-haspopup="true"><span>Due by : <span style="color:'+vColor+';">'+EnddateC+' </span></span></span>|';
                            ...
                            subtaskList +='                     <img class="icon-todo-menu dropbtn" src="icons/Details_Properties.png" id="properties'+value.Id+'" style="    float: right;margin-right: -28%;margin-top: 8%;">';
