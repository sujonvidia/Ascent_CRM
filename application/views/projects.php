            ...
            <ol class="breadcrumb">
                <li style="text-align: center;color: #474544;">
                    ...
                    <ul class="list-inline ribUl" id="ribUl">
                        ...
                        <ol class="ribLi noBorder ribLi5" data-type="dashboard" id="" data-projectid=""><i class="fa fa-line-chart" style="color: #3276b1;" aria-hidden="true"></i></i> Dashboard</ol>
                        <?php } ?>
...
<!-- <div class="contact-header ">My Projects <span class="margintop0"><img id="open_newpro1" class="open_newpro1" src="<?php echo base_url("asset/img/icons/Add Project.png"); ?>" /></span><span class="margintop0"><img id="importProject" style="margin-top: -1.2%;width: 7%;margin-left: 2%;" title="Import Project" onclick="$('#import_csv_in').trigger('click');" class="importProject" src="<?php echo base_url("asset/icons/import.png"); ?>" /></span></div>-->
                         <div class="contact-header ">Projects <span class="margintop0 open_newpro1" id="open_newpro1" ><i class="fa fa-plus hvr-glow clasI" aria-hidden="true"></i></span><span class="margintop0 importProject " id="importProject" onclick="$('#import_csv_in').trigger('click');" ><i class="fa fa-download hvr-glow clasI" aria-hidden="true"></i></span></div>
<!-- <div class="contact-header ">My Projects <span class="margintop0"><img id="open_newpro1" class="open_newpro1" src="<?php echo base_url("asset/img/feedIcon/add_rounded_btn.png"); ?>" /></span></div>-->
                                    ...
                                    <div class="toolDateSpan col-xs-12 col-sm-12 col-md-12 col-lg-12 pull-left">
                                        <div class="row cusmar">
                                            <div class="col-lg-12 col-sm-12 col-md-12">
                                                ...
                                                <span id="DueDateText" style="display:none;">Task By Due Date (ASC)</span>
                                                <a class="dropdown-toggle dd-tog-view taskview" data-toggle="dropdown" > View :   <i class="fa fa-caret-down"></i></a>
                    ...
                    <div class="col-lg-8 TaskproNeDiv">
                        <div class="panel panel-default propertaskDiv">
                                
                            <div class="panel-body font-color">
                                
                                <div id="propertaskDiv" style="padding:0px 15px;">
    ...
    <script>
        ...
        $(".slide-toggle").click(function(){
            ...
            if($("#larrrow").is(":visible")){
                ...
                if($(".TaskproNeDiv").is(':visible')){
                    $(".TaskListDiv").animate({
                        width: "50%"
                    });
                    $(".TaskproNeDiv").animate({
                        width: "49%"
                    });
                }else{
                    $(".TaskListDiv").css('width','76%');
...
<script type="text/javascript">
    ...
    <script type="text/javascript">
            ...
            if($('#backDiv'+param2+projectID).is(":visible")){
                ...
                switch(param2){
                    ...
                    case 'properties':
                                    ...
                                    $(".cusmar").hide();
                                    $(".TaskListDiv").css('width','75%');
                                    $(".TaskproNeDiv").css('display','none');
                                    $(".seperator").css('display','none');
                                    $(".margin-topdown").css('display','none');
                                    $(".taskDiv").css('margin-top','10px');
                                    $(".taskDiv").css('padding-top','0px');
                                    $(".taskDiv").css('border-radius','8px');
                                    $('head').append('<style>.taskDiv:after, .taskDiv:before{right:98.5%;px !important;}</style>');
                    ...
                    case 'attach':
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(data) {
                                            ...
                                            $("#tipA"+projectID).text("");
                                            openAttach(projectID,param2,data.status);
                    ...
                    case 'comments':
                                    ...
                                    break;
                    case 'list':
                                if($("#leftFloat").is(":visible")){
                                    //
                                }else{
                                   $(".TaskproNeDiv").css('width','45%'); 
                                }
                                $(".cusmar").show();
                                $("#inviteeDiv").hide();
                                $(".TaskListDiv").css('width','32%');
                                $(".TaskproNeDiv").css('display','block');
                                $(".seperator").css('display','block');
                                $(".margin-topdown").css('display','block');
                                $(".taskDiv").css('margin-top','0px');
                                $(".taskDiv").css('padding-top','7px');
                                $(".taskDiv").css('border-radius','0px 0px 8px 8px');
                                $('head').append('<style>.taskDiv:after, .taskDiv:before{right:96.5%;px !important;}</style>');
                                ...
                                break;
                    case 'dashboard':
                                    console.log($("#leftFloat").is(":visible"));
                                    if($("#leftFloat").is(":visible")){
        ...
        function openProperties(projectID,attr,viewtype,data){
            ...
            var floatingDiv =  '<div data-attr="'+attr+projectID+'" id="backDiv'+attr+projectID+'">';
                ...
                floatingDiv += '        <div class="panel panel-default" style="border: none;padding:0px 15px;margin-bottom: 0px;margin-left: -15px;margin-right: -15px;">';
                ...
                floatingDiv +='                     <div class="dropdown name">'+
                                                        '<a data-toggle="dropdown" style="position: absolute; right: 132px; top: 12px;" class="dropdown-toggle exportProject" title="Contact">'+
                ...
                floatingDiv += '                    </span>';
                floatingDiv += '                    <span style="font-size: 16px; font-weight: bold;">|</span><span class="cusDue"> Start Date: <i class="fa fa-calendar"></i> <input type="text" data-c="1"  name="projectEnddate" onclick="togglecalendar_start()" class="proInputText2" placeholder="Start Date" id="projectStartDate'+projectID+'" value="'+moment(taskdata.Startdate).format('MMM DD YYYY')+'"></span>';
                floatingDiv += '                    <span style="font-size: 16px; font-weight: bold;">|</span><span class="cusDue"> Due Date: <i class="fa fa-calendar"></i> <input type="text" data-c="1"  name="projectEnddate" onclick="togglecalendar_end()" class="proInputText2" placeholder="Due Date" id="projectendtDate'+projectID+'" value="'+moment(taskdata.Enddate).format('MMM DD YYYY')+'"></span>';
                floatingDiv += '                 </span>';
                ...
                floatingDiv += '                         <span style="float:left;margin-top: 0px;" id="tagBtnDivCOADMIN'+taskdata.Id+'"></span><i class="fa fa-plus btn btn-primary btn-circle btnTag" onClick="userListTaskCO(this,' + taskdata.Id + ')" id="addBtnTag'+taskdata.Id+'"></i>';
                floatingDiv += '                     </span>';
    ...
    <script type="text/javascript">
        ...
        function openAttach(projectID,attr, dStatus = false) {
            ...
            var floatingDiv =  ' <div data-attr="'+attr+projectID+'" id="backDiv'+attr+projectID+'"><div id="Pro'+projectID+'">';
                ...
                floatingDiv += '        </div>';
                floatingDiv += '        <div class="panel-body">'+projectAttachDesign(projectID,"ProjectsFiles",dStatus,"0")+'</div>';
                floatingDiv += '     </div>';
                floatingDiv += ' </div></div>';
        ...
        function openComments(projectID,attr,data){
            ...
            var floatingDiv =  ' <div  data-attr="'+attr+projectID+'" id="backDiv'+attr+projectID+'"><div id="Pro'+projectID+'">';
                ...
                $('.summernoteproject').summernote({
                    ...
                    buttons: {
                        post: '<button type="button" class="note-btn btn btn-default btn-sm chatEmo" tabindex="-1" title="Emoji" onclick="saveProjectsCmnt()"><i class="fa fa-floppy-o note-icon" style="cursor: pointer;font-size: 16px;top:4px;"></i> Post</button>',
                    }
				});
    ...
    <script type="text/javascript">
        ...
        function setProjectAttribute(data){
            ...
            $.each(data.projects, function (key, value) {
                ...
                var credate = moment(data.projects[key].CreatedDate); 
			
                var diff_credate = moment.duration(moment().diff(credate)).asDays();

                if(diff_credate>7){
                    var agostr=credate.format('MMM-DD-YYYY');
                }else{
                    var agostr=moment(data.projects[key].CreatedDate).toNow(true) + " ago";
                }

                var projectitem = '<div class="notifation notifationDel" data-cdate="'+data.projects[key].CreatedDate+'" id="clickDiv'+data.projects[key].Id+'" data-proid = "'+data.projects[key].Id+'">';
                    projectitem += '                    <span style="display:none;" id="userID'+data.projects[key].Id+'">'+data.projects[key].CreatedBy+'</span>';
                    projectitem += '                    <div class="newNotifation relClass" style="height: inherit;">';
                    ...
                    projectitem += '                        <span class="name textdecor" id="protitle'+data.projects[key].Id+'"><b>'+data.projects[key].Title+'</b></span>';
                    projectitem += '<span class="crtdate" style="right: -26px; margin-top: 16px;">'+agostr+'</span>';
                    projectitem += '                    </div>';
    ...
    <script type="text/javascript">
        ...
        function tabsDesign(projectid,attr,viewtype,projectID,data,data){
         ...
         $("#myProjectDivList").on('click','.notifation', function(e){
            ...
            $(".ribLi5").attr('id','dashboardIMG'+targetProjectId);
            $(".ribLi5").attr('data-projectid',targetProjectId);
            ...
            if($(".ribLi5").hasClass('activeOL')){
                 $("#dashboardIMG"+targetProjectId).trigger('click');
            }
            ...
            getTopbartag(targetProjectId,'Project');
        ...
        function CloseFlotDiv(param2,projectID){
         ...
         function getTopbartag(project_ID,type = 'Task'){
            
            $.ajax({
                url: '<?php echo site_url(); ?>Projects/getTopbartag',
                dataType: "JSON",
                type: "POST",
                data:{
        ...
        function setTasktag(data,tagDivID){
            ...
            if(totalMember < 1){
                $("#TaskMemArea"+tagDivID).append('<a style="color:RED;font-size: 12px;margin-top: 5px !important;" id="TaskMemAreanonbtn'+tagDivID+'">[None]</a>');
            }else {
                for(var i = 0;i < totalMember;i++){
        ...
        function taskPropetritesOpen(element,maindata,viewtype){
            ...
            setCookie('taskid',projectID,1);
            setCookie('subtaskid',projectID,1);
            $('.dd-parent').css('backgroundColor','');
            $('.todoRow'+projectID).css('backgroundColor','lavender');
            var offset = $("#readOnlyID"+projectID).offset();
            //console.log(offset);
            
            if(offset != undefined){
                var taskDivy = parseInt(offset.top)-110;
                var floaty = parseInt(offset.top)-100;
                $('head').append('<style>.propertaskDiv:after, .propertaskDiv:before{top:'+taskDivy+'px !important;}</style>');
            }
            ...
            requestass.done(function(data){
                ...
                var floatingDiv =  '<div data-attr="'+viewtype+projectID+'" id="backDiv'+viewtype+projectID+'">';
                    ...
                    floatingDiv += '                <i class="fa fa-check  forceCheck iconGreen iconGreenWS'+taskdata.Id+'" onClick="makeCompleteWS(' + taskdata.Id + ',\''+taskdata.Status+'\',\'Task\');" id="iconGreen' + taskdata.Id + '" style="display:'+sty1+';position: absolute;float: left;" ></i>';
                    floatingDiv += '                <span class="proDivname" style="margin-top:0px;float: left;margin-left: 4%;">';
                    floatingDiv += '                    <span id="todo_name_text'+projectID+'" class="task-properties" style="width: 282px !important; margin-left: 13px;">'+taskdata.Title+'</span>';
                    
                    floatingDiv +='                     <div class="filterDiv">';
                    floatingDiv +='                         <span class="pull-right filter" style="position: absolute; right: 148px; top: 1px;"><i class="fa fa-paperclip hvr-glow clasI customTaskImg" aria-hidden="true" data-type="attach" id="comAttahID" onclick="attacher()"></i></span>';
                    floatingDiv +='                     </div>';
                    floatingDiv +='                     <div><a class="dropdown-toggle procopyIMG hvr-glow clasI" data-toggle="dropdown" style="position: absolute; right: 115px; top: 13px;"><img style="width: 107% !important;margin-top: -200%;" src="'+base_url+'asset/icons/proCopy.png"></a>';
                    ...
                    floatingDiv +='                         </ul></div>';
                    floatingDiv += '                    <i class="fa fa-shield  hvr-glow clasI" aria-hidden="true" onclick="logView()" title="View Log" style="margin-top: -6px;font-size: 14px;right: 83px; top: 13px;position: absolute;"></i>';
                    floatingDiv +='                     <i class="fa fa-trash hvr-glow clasI" aria-hidden="true" onclick="fun_project('+projectID+',\''+viewtype+'\')" style="margin-top: -6px;font-size: 14px;right: 50px; top: 13px;position: absolute;"></i>';
                    floatingDiv += '                    <i class="fa fa-close  hvr-glow clasI" aria-hidden="true" onClick="$(\'.ribLi1\').trigger(\'click\');$(\'.cusmar\').show();" style="color: red;right: 16px; top: 13px;position: absolute;cursor: pointer; margin-top: -6px;font-size: 14px;"></i>';
                    ...
                    floatingDiv +='                     </span>';
                    floatingDiv +='                     <span style="position: absolute; margin-top: 2px; right: 39%;" class="duSpan statusCustomClass" >';
                    floatingDiv +='                         <span style="float: left;" >Status: </span>';
                    floatingDiv +='                         <span class="pull-left taskStatusLi'+taskdata.Id+'  dt-todostatus" id="taskStatusLi'+taskdata.Id+'" data-type="'+taskdata.Type+'" data-serial="'+taskdata.Id+'" data-status="'+taskdata.Status+'" onClick="qtipCustomStatus(this,'+taskdata.Id+',\''+taskdata.Status+'\')" >'+taskdata.Status+'</span>';
                    floatingDiv +='                     </span>';
                    floatingDiv +='                 </span>';
                ...
                $("#propertaskDiv").append(floatingDiv);
                ...
                if ($(this).scrollTop() + $(this).innerHeight() <= parseInt($(this)[0].scrollHeight)) {
                    ...
                    $.each(totalTnTSDate.allTask, function (i, item) {
                        if (i > limitChecking) {
                            ...
                            //Parent Div Start
                            taskDetailStr += '<div ondrop="drop(event)"  ondragover="allowDrop(event)" id="tasklist'+item.Id+'" data-serial="'+item.Id+'" class="taskRow taskRowCus taskRow0604 bottom-border taskDetailDive taskserial'+item.Id+'  dt-todostatus" dt-sta="'+item.Status+'" style="float: left;width:100%;border-left: 5px solid '+blcol+';margin-bottom: -2px;">';
                            //icon Div Start
                            
                            taskDetailStr += '    <div style="width:100%;float:left;" onclick="openPropDyn(event,\'Task\')"   data-serial="'+item.Id+'"  class="TtaskRow" id="readOnlyID'+item.Id+'">';
                            taskDetailStr += '      <div style="width:5%;float:left;padding: 5px 0px;">';
                            taskDetailStr += '          <i class="fa fa-circle" id = "taskcIcon'+item.Id+'" style="display:block;color: #'+inStartClr+';float: left; margin: 21%; padding: 0%; height: 15px; width: 15px;font-size: 18px;"></i>';
                            taskDetailStr += '      </div>';
                            //Main Div Start
                            taskDetailStr += '      <div style="width:85%;float:left;margin-left: 0.5%;padding: 1% 0;">';
                            //Main Div Upper Start
                            taskDetailStr += '          <div class="slineSS" style="width: 100%;">';
                            ...
                            taskDetailStr += '          <span class=""><i style="margin-right: 0px;margin-left: 9%; border-color: #ffffff; color: #ffffff;" class="fa fa-plus hvr-glow clasI cHover open_newpro1" aria-hidden="true" id="projectbtn" title="Create Subtask" onclick="openInput('+item.Id+')"></i></span>';
                            taskDetailStr += '      </div>';
                            taskDetailStr += '    </div>';
                            ...
                            taskDetailStr += '              <div class="col-lg-12 SIDIV">';
                    ...
                    if(getCookie('taskid') != ""){
                        ...
                        $("#openQtipProperty"+getCookie('taskid')).css('color','rgb(14, 14, 14)');
                        $("#openQtipProperty"+getCookie('taskid')).css('background-color','#fafafa');
                        $("#openQtipProperty"+getCookie('taskid')).css('border','3px solid #c54ec2');
                        $("#openQtipProperty"+getCookie('taskid')).css('box-shadow','0px 0px 0px 3px rgb(197, 78, 194) !important');
                        
                        var offset = $("#openQtipProperty"+getCookie('taskid')).offset();
                        
                        if(offset != undefined){
                            var taskDivy = parseInt(offset.top)-100;
                        }
                        $(".taskDiv").animate({scrollTop: taskDivy}, 1000);
        ...
        function drawTaskList(data,status){
            ...
            if(data.allTask.length > 0){
                ...
                $.each(data.allTask, function (i, item) {
                    ...
                    var credate = moment(item.CreatedDate); 
                    ...
                    if(diff_credate>7){
                        ...
                        var agostr=moment(item.CreatedDate).toNow(true) + " ago";
                    }
                    ...
                    taskDetailStr += '      <div style="width:85%;float:left;margin-left: 0.5%;padding: 1% 0;">';
                    //Main Div Upper Start
                    taskDetailStr += '          <div class="slineSS" style="width: 95%;">';
                    taskDetailStr += '              <span data-serial="' + item.Id + '" id="tasktext' + item.Id + '" class="form proName clickontitle tnstitle">' + item.Title + '</span>';
                    
                    taskDetailStr += '          </div>';
                    taskDetailStr += '      </div>';
                    taskDetailStr += '      <div style="width:9%;float:left;margin-top: 1%;" class="relClass">';
                    taskDetailStr += '          <span class="crtdate">'+agostr+'</span>';
                    taskDetailStr += '          <span class=""><i style="margin-right: 0px;margin-left: 9%; border-color: #ffffff; color: #ffffff;" class="fa fa-plus hvr-glow clasI cHover open_newpro1" aria-hidden="true" id="projectbtn" title="Create Subtask" onclick="openInput('+item.Id+')"></i></span>';
                    taskDetailStr += '      </div>';
                    taskDetailStr += '    </div>';
                    taskDetailStr += '    <div style="width:100%;float:left;">';
                ...
                $('.TtaskRow').each(function(k,v){
                    TtaskRowArray.push($(v).context.id);
                });

                $("#"+TtaskRowArray[0]).trigger('click');
                                ...
                                if(data.tag.length>0){
                                    ...
                                    $.each(data.tag, function (key, value) {
                                        ...
                                        if(SC < 2 && SC > 0 ){
                                            ...
                                            taskDetailStr += '  <div class="clipHead cusClip" style="font-size: 14px;">SET ASSIGNEE: <i class="fa fa-share-alt hvr-glow clasI open_newpro1 cHover" aria-hidden="true" id="" title="Assign this task to Guest(s)" style="position: absolute; padding-top: 4px; right: 25px; top: 11px; border-color: #ffffff; color: #000000; width: 25px; height: 25px; padding: 3px;" onclick="'+shareBtnIcon+'(\'Task\','+projectID+',\'tasktext\');"></i> <i class="fa fa-times-circle cCcloeSS qtipCloseDes"></i></div>';
                                        }
                            ...
                            success: function (data, textStatus) {
                                ...
                                if(data.tag.length>0){
                                    ...
                                    $.each(data.tag, function (key, value) {
                                        ...
                                        if(SC < 2 && SC > 0 ){
                                            //taskDetailStr += '<li style="background-color: #333;font-size: 12px;" class="dropdown-menu-header">Assign To</li>';
                                            taskDetailStr += '  <div class="clipHead cusClip">SET MEMBER:</div>';
                                        }
        ...
        function goforduration(id,itemId,type, e) {
           
            var char = e.which || e.keyCode;
            if (char == 13) {
                e.preventDefault();
                getDurationhr(id,itemId,type);
                $("#"+e.target.id).blur();
            }
        }

        function gofordurationday(id,itemId,type, e) {
           
            var char = e.which || e.keyCode;
            if (char == 13) {
                e.preventDefault();
                getDuration(id,itemId,type);
                $("#"+e.target.id).blur();
            }
        }
            ...
            if(valu != NaN){
                ...
                success: function (data_st, textStatus) {
                    ...
                    if(data_st.msg != 'TIMELESS'){
                        ...
                        setCookie('selectedTask',value,1);
                        $("#hrduration"+value).css('color','#808080');
                        //fun_loadfulltable($("#newTaskInput").attr('data-projectid'),'ASC','All'); 
                    }else{
                            ...
                            $.ajax({
                                ...
                                success: function (data, textStatus) {
                                    ...
                                    if(diff_credate>7){
                                        ...
                                        var agostr=moment().toNow(true) + " ago";
                                    }

                                    taskDetailStr += '<div ondrop="drop(event)"   ondragover="allowDrop(event)" id="tasklist'+data.taskInsertID+'" data-serial="'+data.taskInsertID+'" class="taskRow taskRowCus taskRow0604 bottom-border taskDetailDive taskserial'+data.taskInsertID+'  dt-todostatus" dt-sta="none" style="float: left;width:100%;border-left: 5px solid #ffffff;margin-bottom: -2px;">';
                                    //icon Div Start
                                    
                                    taskDetailStr += '    <div style="width:100%;float:left;" onclick="openPropDyn(event,\'Task\')"   data-serial="'+data.taskInsertID+'"  class="TtaskRow" id="readOnlyID'+data.taskInsertID+'">';
                                    taskDetailStr += '      <div style="width:5%;float:left;padding: 5px 0px;">';
                                    taskDetailStr += '          <i class="fa fa-circle" id = "taskcIcon'+data.taskInsertID+'" style="display:block;color: #bfbfbf;float: left; margin: 21%; padding: 0%; height: 15px; width: 15px;font-size: 18px;"></i>';
                                    taskDetailStr += '      </div>';
                                    //Main Div Start
                                    taskDetailStr += '      <div style="width:85%;float:left;margin-left: 0.5%;padding: 1% 0;">';
                                    //Main Div Upper Start
                                    ...
                                    taskDetailStr += '      </div>';
                                    taskDetailStr += '      <div style="width:9%;float:left;margin-top: 1%;" class="relClass">';
                                    taskDetailStr += '          <span class="crtdate" style="width:125px;">'+agostr+'</span>';
                                    taskDetailStr += '          <span class=""><i style="margin-right: 0px;margin-left: 9%; border-color: #ffffff; color: #ffffff;" class="fa fa-plus hvr-glow clasI cHover open_newpro1" aria-hidden="true" id="projectbtn" title="Create Subtask" onclick="openInput('+data.taskInsertID+')"></i></span>';
                                    taskDetailStr += '      </div>';
                                    taskDetailStr += '    </div>';
                                    taskDetailStr += '    <div style="width:100%;float:left;">';
                                    ...
                                    $('#readOnlyID'+data.taskInsertID).trigger('click')
    ...
    /////////////////////////////////////////////// Enter key press \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
        ...
        $(document).mouseup(function (e) {
                    ...
                    && container.has(e.target).length === 0) // ... nor a descendant of the container
            {
                ...
                $("#attachListDivCommnet").css('margin-top','2%');
                ...
                if(projectID != "" && $("#" + targetID).val() != ""){
                    $.ajax({
                        ...
                        success: function (data, textStatus) {
                            ...
                            $("#taskcIcon"+taskid).css('color','#bfbfbf');
                ...
                success: function (data_st, textStatus) {
                    ...
                    if(data_st.allSubTask.length > 0){
                        $.each(data_st.allSubTask, function (index, value) {
                            ...
                            var credate = moment(value.CreatedDate); 
                            ...
                            if(diff_credate>7){
                                ...
                                var agostr=moment(value.CreatedDate).toNow(true) + " ago";
                            }
                            

                            subtaskList ='       <div class="col-lg-12 SIDIV" style="margin-bottom: 3px;">';
                            ...
                            subtaskList += '<div draggable="true" onclick="openPropDyn(event,\'SubTask\')" data-serial="'+value.Id+'" ondragstart="drag(event,'+value.Id+')"  class="'+clas+' subtaskDetailDive '+status+'" id="subtaskDetailDive'+value.Id+'">';
                            //icon Div Start
                            ...
                            subtaskList += '      <div style="width:5%;float:left;padding: 5px 0px;">';
                            
                            subtaskList += '             <i class="fa fa-circle" id = "taskcIcon'+value.Id+'" style="display:block;color: #'+inStartClr+';float: left; margin: 14%; padding: 0%;font-size: 14px;"></i>';
                            subtaskList += '      </div>';
                            //Main Div Start
                            subtaskList += '      <div style="width: 84%; margin-right: 3%; float: left; margin-left: 0.5%;">';
                            //Main Div Upper Start
                            subtaskList += '          <div style="width: 95%;>';
                            ...
                            //Right Div Start
                            subtaskList += '      <div style="width:6%;float:left;margin-top: 0%;"  class="relClass">';
                            subtaskList += '             <span class="crtdate" style="right: -33px;">'+agostr+'</span>';
                            subtaskList += '                <div class="dropdownCus" style="width:100%;" >'; 
                            subtaskList +='                     <i style="float: left; margin-right: 0px; margin-top: 1%; border-color: #ffffff; color: #ffffff;" class="fa fa-plus hvr-glow clasI cHover open_newpro1" aria-hidden="true" id="projectbtn" title="Add Sub Task" onclick="openSubIn('+value.Id+')"></i>';
                            subtaskList += '                </div>'; 
                            subtaskList += '      </div>';
                            subtaskList += '    </div>';
                            subtaskList += '    <div style="width:100%;float:left;">';
                        ...
                        console.log("Subtask Checking");
                        console.log(getCookie('subtaskid'));

                        if(getCookie('subtaskid') != ""){
                    
                            $("#SubopenQtipProperty"+getCookie('subtaskid')).css('color','rgb(14, 14, 14)');
                            $("#SubopenQtipProperty"+getCookie('subtaskid')).css('background-color','#fafafa');
                            $("#SubopenQtipProperty"+getCookie('subtaskid')).css('border','3px solid #c54ec2');
                            
                            

                            var offset = $("#SubopenQtipProperty"+getCookie('subtaskid')).offset();
                            if(offset != undefined){
                                var taskDivy = parseInt(offset.top)-100;
                            }
                            $(".taskDiv").animate({scrollTop: taskDivy}, 1000);
                            setCookie('subtaskid',getCookie('subtaskid'),0);
                        }
        ...
        function tabsDesignProjectNEW(projectid,viewtype,parentID,taskdata,data){
            var tabsDesign='';
            tabsDesign += ' <div class="tab-content" style="padding: 10px;">';
            tabsDesign += '     <div id="home" class="tab-pane fade in active">';
            tabsDesign +=           propertiesProjecttabNEW(projectid,viewtype,parentID,taskdata,data);
            tabsDesign += '     </div>';
            tabsDesign += ' </div>';
                                ...
                                // }else{
                                    ...
                                    if(type_id == 3){
                                        ...
                                        $.each(response.task_detail, function(k,v){
                                            ...
                                            qtc+= '<p style="padding:3px;font-size:12px">'+response.user_detail[k][0].email+'</p><p style="padding:3px;font-size:12px">';
                                        ...
                                        qtc+= '<p style="padding:3px;font-size:12px" >'+response.user_detail[0].email+'</p><p style="padding:3px;font-size:12px">';
...
<script type="text/javascript">
    ...
    $(document).on('blur','.clickontitle',function(e){
        ...
        if($(e.currentTarget).text() !=""){
            ...
            swal("Opps!!", "Empty is not allowed", "error");
            // $(e.currentTarget).select();
        }
    });
...
<script type="text/javascript">
   ...
   var datatable = $('#report_table').dataTable({
    ...
    function saveStatusPostCmnt(){
		    
            var valuee = $('.summernoteTask').summernote('code');
			var type = $("#commentinputNEWForTask").attr('data-status');
			var action = $("#commentinputNEWForTask").attr('data-action');
			valuee = valuee.replace(/[<]br[^>]*[>]/gi,"");
			
			var taskID = $("#taskid").val();
			var projectID = $('.TtaskRow.active').closest('.dd-parent').attr('data-serial');
    ...
    function openPropDyn(event,type){
        console.log('openPropDyn',event);
        var offset = $("#"+event.target.id).offset();
        //console.log(offset);
        
        if(offset != undefined){
            var taskDivy = parseInt(offset.top)-60;
            var floaty = parseInt(offset.top)-100;
            $('head').append('<style>.propertaskDiv:before{top:'+taskDivy+'px !important;}</style>');
        }
        

        var projectID=($(event.currentTarget).attr('data-serial'));
        $('.TtaskRow').removeClass('active');
        $('.subtaskRow').removeClass('active');
        
        if(projectID == undefined){
            var projectIDNEW = $("#"+event.target.id).attr('data-serial');
            $('#readOnlyID'+projectIDNEW).addClass('active');
            getPropertyInfoDyn(projectIDNEW,0,type);
        }else{
            $('#readOnlyID'+projectID).addClass('active');
            getPropertyInfoDyn(projectID,0,type);
        }
    ...
    function propertiesProjecttabNEW(projectid,viewtype,parentID,taskdata,data){
            ...
            tabDetail ='    <div class="propertiesDIVNew">';

            tabDetail +='   <div>';
            tabDetail +='       <div id="commentinputNEWForTask" style="" contenteditable data-status="TaskCmnt" data-action="0" class="summernoteTask commentinputClas'+projectid+'"></div>';
            tabDetail +='           <input type="hidden" id="taskid" data-status="Project" class="form-control taskid" value="'+projectid+'"/>';
            tabDetail +='       </div>';
            tabDetail +='   </div>';
            ...
            $.each(data.allComm,function(k,v){
                ...
                if(className != ''){
                    var str = '<span style="font-size: 14px;font-weight: bold;margin-left: 5px;"><i class="fa fa-paperclip flipFont" aria-hidden="true"></i> attached</span>';
					}else{
                    str = '';
				}
            ...
            tabDetail +=' </div>';
            tabDetail +='<div style="display:none" class="panel-footer">';
			
            tabDetail +='    <div class="taskComments" style="width: 95%;     bottom: 20px;    left: 18px;">';
            ...
            tabDetail +='           <input type="hidden" id="taskid" data-status="Task" class="form-control taskid" value="'+projectid+'"/>';
            tabDetail +='           <img src="'+base_url+'asset/icons/emo.png" onclick="on_off_com_emo_popup()" id="input_img1">';
            tabDetail +='           <a data-title="Attachment" data-toggle="lightbox" title="Attachment" href="'+base_url+'/projects/comattach/Todo/'+projectid+'/TodoFiles">';
            tabDetail +='               <img src="'+base_url+'asset/icons/attach.png" id="input_img2">';
            tabDetail +='           </a>';
		...
		function getPropertyInfoDyn(projectID,parentID,viewtype){
			setCookie('quicklist',projectID,1);
			...
			requestass.done(function(data){
				...
				var taskdata = item= data.all_todos[0];

				var todo_serial=item.Id;
				...
				var todo_name=item.Title;
				var todo_status=item.Status;
				var tag_ids='',mem_ids='';
				var nty_chat=0;
				var nty_file=0;
				var nowid=$.now();
				...
				if((item.CreatedBy != user_id) && (Number(item.status_chat)>0)  )
					nty_chat=Number(item.status_chat);
				
				if((item.CreatedBy != user_id) && (Number(item.status_attach)>0)  )
					nty_file=Number(item.status_attach);
				
				
				if(item.tag_ids != undefined) tag_ids=item.tag_ids;
				if(item.mem_ids != undefined) mem_ids=item.mem_ids;
				...
				var floatingDiv =  '<div class="propDivOpened" data-attr="'+viewtype+projectID+'" id="backDiv'+viewtype+projectID+'">'; // backDiv
				floatingDiv += '<div id="Pro'+projectID+'">'; // Pro

				floatingDiv += '<div class="panel panel-default" style="border: none;margin-bottom: 0px;margin-left: -15px;margin-right: -15px;">'; // panel main

				floatingDiv += '<div class="panel-heading customSelect" style="height:135px;">'; // panel heading



				floatingDiv += '<div class="proDivname" style="margin-top:0px;height:32px">'; // title info div

				floatingDiv += '<span id="todo_name_text'+projectID+'" class="task-properties" style="width:71% !important;white-space: nowrap;text-overflow: ellipsis;overflow:hidden">'+taskdata.Title;
				floatingDiv +='</span>';
                floatingDiv +='                     <div class="filterDiv">';
                floatingDiv +='                         <span class="pull-right filter" style="position: absolute; right: 127px; top: 1px;"><i class="fa fa-paperclip hvr-glow clasI customTaskImg" aria-hidden="true" data-type="attach" id="comAttahID" onclick="attacher()"></i></span>';
                floatingDiv +='                     </div>';
                floatingDiv +='                     <div><a class="dropdown-toggle procopyIMG hvr-glow clasI" data-toggle="dropdown" style="position: absolute; right: 93px; top: 13px;"><img style="width: 107% !important;margin-top: -200%;" src="'+base_url+'asset/icons/proCopy.png"></a>';
                floatingDiv +='                         <ul class="dropdown-menu pull-right" style="padding-top:0px;position: absolute;top: 95px;">';
                floatingDiv +='                             <li style="background-color: #6d6a69;" class="dropdown-menu-header">Projects:</li>';
                floatingDiv +='                             <div class="arrow-top-right"></div>';
                $.each(allprojects, function (key, value) {
                ...
                floatingDiv +='                         </ul></div>';
                floatingDiv += '                    <i class="fa fa-shield  hvr-glow clasI" aria-hidden="true" onclick="logView()" title="View Log" style="margin-top: -6px;font-size: 14px;right: 58px; top: 13px;position: absolute;"></i>';
                floatingDiv +='                     <i class="fa fa-trash hvr-glow clasI" aria-hidden="true" onclick="fun_project('+projectID+',\''+viewtype+'\')" style="margin-top: -6px;font-size: 14px;right: 24px; top: 13px;position: absolute;"></i>';
                //floatingDiv += '                    <i class="fa fa-close  hvr-glow clasI" aria-hidden="true" onClick="$(\'.ribLi1\').trigger(\'click\');$(\'.cusmar\').show();" style="color: red;right: 16px; top: 13px;position: absolute;cursor: pointer; margin-top: -6px;font-size: 14px;"></i>';
                
                floatingDiv +='</div>'; // title info div
                floatingDiv +='<div class="seperator" style="margin-bottom: 1%;"></div>';
				// start info row

				floatingDiv += '          <div class="todo-info-row"  style="width:100%;height: 15px;margin: 0px 5px 11px 5px;">';
				floatingDiv +='               <span class="duSpan" style="border: 3px solid #f5f5f5;">Created by:'+taskdata.creator_name+'</span> |';
				floatingDiv += '              <span class="span3" ><span style="border: 3px solid #f5f5f5;" class="duSpan dropdown-toggle pointer" aria-hidden="true" data-toggle="dropdown" aria-haspopup="true"><span >Start: <span><input type="text" id="startDatein' + taskdata.Id + '" name="mydate" style="color:'+SColor+';width: '+StartdateW+';" class="datepicker customdate" data-dateformat="M d yy"  value="'+StartdateC+'"></span></span></span>|';
				floatingDiv += '              <span class="span3" style="margin-left: 0%;"><span style="border: 3px solid #f5f5f5;" class="duSpan dropdown-toggle pointer" aria-hidden="true" data-toggle="dropdown" aria-haspopup="true"><span >Due by: <span style="color:'+vColor+';"><input  type="text" id="endDateinNew' + taskdata.Id + '" style="color:'+vColor+';width: '+EnddateW+';" name="mydate" class="datepicker taskDate customdate " data-dateformat="M d yy" value="'+EnddateC+'"></span></span></span>';
				floatingDiv += '              <span style="z-index: 100;position: relative;display:none;"  id="subTaskcountbtn' + taskdata.Id + '" class="duSpan subTaskcountbtn">| <span><i style="margin-top:5px;" class="fa fa-indent" aria-hidden="true"></i> </span><span id="subTaskcountbtnValue' + taskdata.Id + '" style="padding-right: 7px;"></span></span>'+shareBtnNew;
				floatingDiv += '          </div>';
                
                floatingDiv += '          <div class="todo-info-row"  style="width:100%;height: 25px;margin:5px">';
				floatingDiv += '              <span data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle" aria-hidden="true" style="margin-right: 0px;-webkit-box-shadow: none;box-shadow: none;"><span class="duSpan pointer" id="duraCogBtn'+taskdata.Id+'" style="border: 3px solid #f5f5f5;"> Duration: <input type="text" style="color:'+duColor+';width:'+wid+';background-color:transparent" class="duarationClass duSInput duraCogBtn'+taskdata.Id+'" onchange="getDuration($(this).data(\'id\'),' + taskdata.Id + ',\'startDatein\')" data-id="duration' + taskdata.Id + '" id="duration' + taskdata.Id + '" value="'+dueColorS+'"></span></span>|';
				floatingDiv += '              <span data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle pointer" aria-hidden="true" id="hrCogBtn'+item.Id+'" style="margin-right: 0px;-webkit-box-shadow: none;box-shadow: none;"><span class="duSpan" style="border: 3px solid #f5f5f5;"> Hours: <input type="text" style="color:'+HourColor+';width: '+widHr+';font-size: 11px !important;background-color:transparent" class="duarationClass duSInput hrCogBtn'+taskdata.Id+'" onchange="getDurationhr($(this).data(\'id\'),' + taskdata.Id + ',\'task\')" data-id="hrduration' + taskdata.Id + '" id="hrduration' + taskdata.Id + '" value="'+endcColorS+'"></span></span>|';
				floatingDiv += '              <span style="z-index: 100;position: relative;border: 3px solid #f5f5f5;" class="duSpan" ><span clas="link_status_text'+taskdata.Id+'  dt-todostatus" id="Levopenstatus'+taskdata.Id+'" data-type="'+taskdata.Type+'" data-serial="'+taskdata.Id+'" data-status="'+taskdata.Status+'" > Status:  </span> <span  class="link_status_text'+taskdata.Id+'  dt-todostatus deleteStatus" id="openstatus'+taskdata.Id+'" data-type="'+taskdata.Type+'" data-serial="'+taskdata.Id+'" data-status="'+taskdata.Status+'" >'+taskdata.Status+'</span> </span>';
				floatingDiv += '              <span style="z-index: 100;position: relative;display:none;border: 3px solid #f5f5f5;"  id="subTaskcountbtn' + taskdata.Id + '" class="duSpan subTaskcountbtn">| <span><i style="margin-top:5px;" class="fa fa-indent" aria-hidden="true"></i> </span><span id="subTaskcountbtnValue' + taskdata.Id + '" style="padding-right: 7px;"></span></span>'+shareBtnNew;
				floatingDiv += '              <i title="Mark as completed" class="fa fa-check forceCheck  iconGray iconGrayWS'+taskdata.Id+'"  onClick="makeCompleteWS(' + taskdata.Id + ',\''+taskdata.Status+'\',\'Todo\');" id="iconGray' + taskdata.Id + '" style="display:'+sty2+';float: right;" >'
				floatingDiv += '              </i>';
                floatingDiv += '              <i title="Completed" class="fa fa-check  forceCheck iconGreen iconGreenWS'+taskdata.Id+'" onClick="makeCompleteWS(' + taskdata.Id + ',\'completed\',\'Todo\');" id="iconGreen' + taskdata.Id + '" style="display:'+sty1+';float: right;" >';
				floatingDiv += '              </i>';
                floatingDiv += '          </div>';
				// end info row
				...
				floatingDiv +='<div class="ql-memberstatus-row">'; // start members & status row
				floatingDiv +='     <div style="float:left">'; // start members
                floatingDiv +='         <span id="member_addDiv" style="border: 3px solid #f5f5f5;height: 28px; padding-left: 0px !important; margin-top: -5px; margin-left: 5px;" class="pull-left duSpan">'; // members
                floatingDiv +='             <span style="" onClick="TaskUserList(\'TaskMemArea\',this,' + taskdata.Id + ',\'2\')">Members:</span>';
                floatingDiv +='             <span class="" id="TaskMemArea'+taskdata.Id+'"></span>';
                floatingDiv +='             <i class="fa fa-plus btn-primary btn-circle btnTag" onClick="TaskUserList(\'TaskMemArea\',this,' + taskdata.Id + ',\'2\')" id="addBtnTag'+taskdata.Id+'" style="padding-top: 1px !important;"></i>';
				floatingDiv +='         </span>'; 
                floatingDiv +='     </div>';  // end members
                floatingDiv +='     <div style="float:right">'; // start status
                floatingDiv += '    </div>'; // end status
				floatingDiv += '</div>'; // end members & status row

				floatingDiv += '</div>'; // panel heading

				floatingDiv += '<div id="dynprop_body" class="panel-body"  style="padding-top: 0px;">'+tabsDesignProjectNEW(projectID,viewtype,parentID,taskdata,data); // panel body
				floatingDiv +='</div>'; // panel body

				floatingDiv += '</div>'; // panel main

				floatingDiv += '</div>'; // Pro
				floatingDiv += '</div>'; // backDiv
				
				$('#propertaskDiv').html(floatingDiv);

				
				console.log('isfocus',!$("#tasktext"+projectID).is(":focus"));

				$('.summernoteTask').summernote({
					height: 80,
					placeholder: 'Write a comment',
					toolbar: [
						['style', ['style']],
                    ...
                    buttons: {
                        post: '<button type="button" class="note-btn btn btn-default btn-sm chatEmo" tabindex="-1" title="Emoji" onclick="saveStatusPostCmnt()"><i class="fa fa-floppy-o note-icon" style="cursor: pointer;font-size: 16px;top:4px;"></i> Post</button>',
                    }
				});
				...
				$('#openstatus'+taskdata.Id).click(function(){
					qtipStatus(this,item);
				});
				
				
				$('#Levopenstatus'+taskdata.Id).click(function(){
					qtipStatus(this,item);
				});
