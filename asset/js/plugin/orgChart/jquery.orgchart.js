(function($) {
    ...
    $.fn.orgChart.defaults = {
        data: [{id:1, name:'Root', parent: 0, description: 'asd ddfas', imglst: 'img'}],
        showControls: false,
        allowEdit: false,
        onAddNode: null,
        onDeleteNode: null,
    ...
    function OrgChart($container, opts){
        ...
        this.newNode = function(parentId){
            ...
            console.log("line100: "+nextId);
            console.log("line101: "+parentId);
        }
    ...
    function Node(data){
        ...
        this.formatNode = function(opts){
            ...
            if(typeof data.description !== 'undefined'){
                descString = '<p class="orgDiscription">'+self.data.description+'</p>';
                descString += self.data.imglst;
                // descString += '<img src="http://172.16.0.64/yeezy/require/dist/img/dipok.jpg"class="online tag">';
                // descString += '<img src="http://172.16.0.64/yeezy/require/dist/img/Hydrangeas.JPG"class="online tag">';
                // descString += '<img src="http://172.16.0.64/yeezy/require/dist/img/mejba.jpg"class="online tag">';
            }
