            ...
            <ol class="breadcrumb">
                <li style="text-align: center;color: #474544;">
                    ...
                    <ul class="list-inline ribUl" id="ribUl">
                        ...
                        <ol class="ribLi noBorder ribLi5" onclick="generatePreview(this)"data-type="properties" id="" data-projectid=""><i class="fa fa-line-chart" style="color: #3276b1;" aria-hidden="true"></i></i> Dashboard</ol>
                        <?php } ?>
        ...
        function openProperties(projectID,attr,viewtype,data){
            ...
            var floatingDiv =  '<div data-attr="'+attr+projectID+'" id="backDiv'+attr+projectID+'">';
                ...
                floatingDiv +='                     <div class="dropdown name">'+
                                                        '<a data-toggle="dropdown" style="position: absolute; right: 135px; top: 8px;" class="dropdown-toggle exportProject" title="Contact">'+
        ...
        function setProjectAttribute(data){
            ...
            $.each(data.projects, function (key, value) {
                ...
                var projectitem = '<div class="panel panel-default notifation notifationDel" data-cdate="'+data.projects[key].CreatedDate+'" id="clickDiv'+data.projects[key].Id+'" data-proid = "'+data.projects[key].Id+'">';
                    ...
                    projectitem += '                        <span class="name"><b class="textdecor" id="protitle'+data.projects[key].Id+'">'+data.projects[key].Title+'</b></span>';
        ...
        function taskPropetritesOpen(element,maindata,viewtype){
            ...
            requestass.done(function(data){
                ...
                var floatingDiv =  '<div data-attr="'+viewtype+projectID+'" id="backDiv'+viewtype+projectID+'">';
                    ...
                    floatingDiv +='                     </div>';
                    floatingDiv +='                     <div><a class="dropdown-toggle procopyIMG hvr-glow clasI" data-toggle="dropdown" style="position: absolute; right: 106px; top: 40px;"><img style="width: 107% !important;margin-top: -200%;" src="'+base_url+'asset/icons/proCopy.png"></a>';
                    ...
                    floatingDiv += '                        <span style="padding: 6px 0px 6px 0px;margin-top: 8px;">Created By: '+taskdata.creator_name+' On <span id="projectStDt'+projectID+'">'+moment(taskdata.CreatedDate).format('MMM DD YYYY')+'</span>';
                    floatingDiv += '                    </span>';
                    floatingDiv += '                    <span style="font-size: 16px; font-weight: bold;">|</span><span class="cusDue"> Start Date: <i class="fa fa-calendar"></i> <input type="text" data-c="1"  name="projectEnddate" onclick="togglecalendar_start()" class="proInputText2" placeholder="Start Date" id="projectstartDateT'+projectID+'" value="'+moment(taskdata.Startdate).format('MMM DD YYYY')+'"></span>';
                    floatingDiv += '                    <span style="font-size: 16px; font-weight: bold;">|</span><span class="cusDue"> Due Date: <i class="fa fa-calendar"></i> <input type="text" data-c="1"  name="projectEnddate" onclick="togglecalendar_end()" class="proInputText2" placeholder="Due Date" id="projectendtDateT'+projectID+'" value="'+moment(taskdata.Enddate).format('MMM DD YYYY')+'"></span>';
                    floatingDiv += '                </span>';
                    floatingDiv +='                 <span style="margin-top: 5px;width:100%;font-size: 11px;font-family: NavigateFont";" class="pull-left properDu">';
                ...
                if ($(this).scrollTop() + $(this).innerHeight() <= parseInt($(this)[0].scrollHeight)) {
                    ...
                    $.each(totalTnTSDate.allTask, function (i, item) {
                        if (i > limitChecking) {
                            ...
                            taskDetailStr += '      </div>';
                            //Main Div Start
                            taskDetailStr += '      <div style="width:86%;float:left;margin-left:-1.5%;">';
        ...
        function drawTaskList(data,status){
            ...
            if(data.allTask.length > 0){
                ...
                $.each(data.allTask, function (i, item) {
                    ...
                    taskDetailStr += '              <span class="span3" style="margin-left: 0%;"><span class="duSpan dropdown-toggle pointer" aria-hidden="true" data-toggle="dropdown" aria-haspopup="true"><span >Start: <span><input onclick="togglecalendar_startPro(' + item.Id + ')" data-c = "1" type="text" id="startDatein' + item.Id + '" name="mydate" style="color:'+SColor+';width: 17%;" class="datepicker customdate" data-dateformat="M d yy"  value="'+StartdateC+'"></span></span></span>|';
                    taskDetailStr += '              <span class="span3" style="margin-left: 0%;"><span class="duSpan dropdown-toggle pointer" aria-hidden="true" data-toggle="dropdown" aria-haspopup="true"><span >Due by: <span style="color:'+vColor+';"><input onclick="togglecalendar_endPro(' + item.Id + ')" type="text" id="endDateinNew' + item.Id + '" style="color:'+vColor+';width: 17%;" name="mydate" class="datepicker taskDate customdate " data-dateformat="M d yy" value="'+EnddateC+'"></span></span></span>|';
                    taskDetailStr += '              <span data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle" aria-hidden="true" style="margin-right: 6px;-webkit-box-shadow: none;box-shadow: none;"><span class="duSpan pointer" id="duraCogBtn'+item.Id+'"> Duration: <input type="text" style="color:'+duColor+';width:'+wid+';" class="duarationClass duSInput duraCogBtn'+item.Id+'"  onkeyup="gofordurationday($(this).data(\'id\'),' + item.Id + ',\'startDatein\',event)" onchange="getDuration($(this).data(\'id\'),' + item.Id + ',\'startDatein\')" data-id="duration' + item.Id + '" id="duration' + item.Id + '" value="'+dueColorS+'" /></span></span>|';
                    taskDetailStr += '              <span data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle pointer" aria-hidden="true" id="hrCogBtn'+item.Id+'" style="margin-right: 6px;-webkit-box-shadow: none;box-shadow: none;"><span class="duSpan"> Hours: <input type="text" style="color:'+HourColor+';width: '+widHr+';font-size: 11px !important;" class="duarationClass duSInput hrCogBtn'+item.Id+'" onkeyup="goforduration($(this).data(\'id\'),' + item.Id + ',\'task\',event)" onchange="getDurationhr($(this).data(\'id\'),' + item.Id + ',\'task\')" data-id="hrduration' + item.Id + '" id="hrduration' + item.Id + '" value="'+endcColorS+'" /></span></span>|';
                    ...
                    // alert(remainTnTS);
                    // alert(totalTnTSDate.totalSubTask[i].TotalSub);
                    // alert(limitChecking);
                        ...
                        if(projectId != "" && $("#newTaskInput").val() != ""){
                            $.ajax({
                                ...
                                success: function (data, textStatus) {
                                    ...
                                    //Parent Div Start
                                    taskDetailStr += '<div ondrop="drop(event)" ondragover="allowDrop(event)"  data-serial="'+data.taskInsertID+'" class="taskRow taskRowCus taskRow0604 bottom-border taskDetailDive taskserial'+data.taskInsertID+'  dt-todostatus" dt-sta="none" style="float: left;width:100%;border-left: 5px solid '+data.taskInsertID+';margin-bottom: -2px;">';
                                    //icon Div Start
                                    
                                    taskDetailStr += '    <div style="width:100%;float:left;"  class="TtaskRow" id="readOnlyID'+data.taskInsertID+'">';
                                    taskDetailStr += '      <div style="width:5%;float:left;">';
                                    taskDetailStr += '          <i class="fa fa-circle" style="display:block;color: #bfbfbf;float: left; margin: 21%; padding: 0%; height: 15px; width: 15px;font-size: 18px;"></i>';
                                    taskDetailStr += '      </div>';
                                    //Main Div Start
                                    taskDetailStr += '      <div style="width:86%;float:left;margin-left: -1.5%;">';
                                    //Main Div Upper Start
                                    ...
                                    taskDetailStr += '          <div style="width:109%;height: 25px;margin-top: 7px;margin-bottom: 7px;">';
                                    //Main Div Due By POPUP Start
                                    taskDetailStr += '              <span class="span3" style="margin-left: 0%;"><span class="duSpan dropdown-toggle pointer" aria-hidden="true" data-toggle="dropdown" aria-haspopup="true"><span >Start: <span><input onclick="togglecalendar_startPro(' + data.taskInsertID + ')" data-c = "1" type="text" id="startDatein' + data.taskInsertID + '" name="mydate" style="color:RED;width: 17%;" class="datepicker customdate" data-dateformat="M d yy"  value="[No due date]"></span></span></span>|';
                                    taskDetailStr += '              <span class="span3" style="margin-left: 0%;"><span class="duSpan dropdown-toggle pointer" aria-hidden="true" data-toggle="dropdown" aria-haspopup="true"><span >Due by: <span style="color:RED;"><input onclick="togglecalendar_endPro(' + data.taskInsertID + ')" type="text" id="endDateinNew' + data.taskInsertID + '" style="color:RED;width: 17%;" name="mydate" class="datepicker taskDate customdate " data-dateformat="M d yy" value="[No due date]"></span></span></span>|';
                                    taskDetailStr += '              <span data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle" aria-hidden="true" style="margin-right: 6px;-webkit-box-shadow: none;box-shadow: none;"><span class="duSpan pointer" id="duraCogBtn'+data.taskInsertID+'"> Duration: <input type="text" style="color:RED;width:5%;" class="duarationClass duSInput duraCogBtn'+data.taskInsertID+'" onchange="getDuration($(this).data(\'id\'),' + data.taskInsertID + ',\'startDatein\')" data-id="duration' + data.taskInsertID + '" id="duration' + data.taskInsertID + '" value="[None]" /></span></span>|';
                                    taskDetailStr += '              <span data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle pointer" aria-hidden="true" id="hrCogBtn'+data.taskInsertID+'" style="margin-right: 6px;-webkit-box-shadow: none;box-shadow: none;"><span class="duSpan"> Hours: <input type="text" style="color:RED;width: 5%;font-size: 11px !important;" class="duarationClass duSInput hrCogBtn'+data.taskInsertID+'" onchange="getDurationhr($(this).data(\'id\'),' + data.taskInsertID + ',\'task\')" data-id="hrduration' + data.taskInsertID + '" id="hrduration' + data.taskInsertID + '" value="[None]" /></span></span>|';
                                    taskDetailStr += '              <span style="z-index: 100;position: relative;" class="duSpan" ><span clas="link_status_text'+data.taskInsertID+'  dt-todostatus" id="Levopenstatus'+data.taskInsertID+'" data-type="Task" data-serial="'+data.taskInsertID+'" data-status="none" > Status:  </span> <span  class="link_status_text'+data.taskInsertID+'  dt-todostatus deleteStatus" id="openstatus'+data.taskInsertID+'" data-type="Task" data-serial="'+data.taskInsertID+'" data-status="none" >[None]</span> </span>|<span onClick="userListTask(this,' + data.taskInsertID + ','+item.isShared+')"  class="duSpan"><i class="fa fa-user" aria-hidden="true" style="font-size: 15px;margin-right: 5px;margin-top: 3px;"></i> <span style="margin-top: -3px;position: relative;margin-left: 0%;" class="taskTagBtnDiv" id="tagBtnDiv'+data.taskInsertID+'"></span> </span>';
                                    taskDetailStr += '              <span style="z-index: 100;position: relative;"  id="subTaskcountbtn' + data.taskInsertID + '" class="duSpan subTaskcountbtn">| <span><i style="margin-top:5px;" class="fa fa-indent" aria-hidden="true"></i> </span><span id="subTaskcountbtnValue' + data.taskInsertID + '" style="padding-right: 0px;"></span></span>';
                                    taskDetailStr += '          </div>';
                                    taskDetailStr += '      </div>';
                                    taskDetailStr += '      <div style="width:9%;float:left;margin-top: 1%;">';
                                    taskDetailStr += '          <span class=""><i style="margin-right: 0px; margin-left: -80px; border-color: #ffffff; color: #ffffff;" class="fa fa-plus hvr-glow clasI cHover open_newpro1" aria-hidden="true" id="projectbtn" title="Create Subtask" onclick="openInput('+data.taskInsertID+')"></i><i class="fa fa-check cusIconCom"  onClick="makeComplete(' + data.taskInsertID + ',\'none\',\'Task\');" id="iconGray' + data.taskInsertID + '" style="display:block;margin-left: -5px !important;" ></i><i class="fa fa-check cusIconInCom" onClick="makeComplete(' + data.taskInsertID + ',\'none\',\'Task\');" id="iconGreen' + data.taskInsertID + '" style="display:none; margin-left: -5px !important;" ></i></span><i class="fa fa-ellipsis-h hvr-glow clasI cHover" id="openQtipProperty' + data.taskInsertID + '" style="position: relative;margin-top: 1%;right: -68%;border-color: #ffffff;color: #ffffff;"></i>';
                                    taskDetailStr += '      </div>';
                                    taskDetailStr += '    </div>';
                                    taskDetailStr += '    <div style="width:100%;float:left;">';
                ...
                success: function (data_st, textStatus) {
                    ...
                    if(data_st.allSubTask.length > 0){
                        $.each(data_st.allSubTask, function (index, value) {
                            ...
                            subtaskList += '             <i class="fa fa-circle" id = "taskcIcon'+value.Id+'" style="display:block;color: #'+inStartClr+';float: left; margin: 14%; padding: 0%; height: 15px; width: 15px;font-size: 18px;"></i>';
                            subtaskList += '      </div>';
                            //Main Div Start
                            subtaskList += '      <div style="width:83%;float:left;margin-left: -1.5%;">';
                            //Main Div Upper Start
                            ...
                            subtaskList += '          </div>';
                            //Main Div Lower Start
                            subtaskList += '          <div style="width: 117%;height: 29px;margin-top: 5px;">';
                            //Main Div Due By POPUP Start
                            ...
                            subtaskList += '              <span data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle" aria-hidden="true"  style="margin-right: 6px;-webkit-box-shadow: none;box-shadow: none;"><span class="duSpan pointer" id="duraCogBtn'+value.Id+'">Duration: <span style="color:'+sHourColor+'"><input type="text" style="color:'+sHourColor+';width:'+wid+';" class="duarationClass duraCogBtn'+value.Id+'" onkeyup="gofordurationday($(this).data(\'id\'),' + value.Id + ',\'SubstartDatein\',event)" onchange="getDuration($(this).data(\'id\'),' + value.Id + ',\'SubstartDatein\')" data-id="Subduration' + value.Id + '" id="Subduration' + value.Id + '" value="'+ssdura+'" /></span> </span></span>|';
                            subtaskList += '              <span data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle" aria-hidden="true"  style="margin-right: 6px;-webkit-box-shadow: none;box-shadow: none;"><span class="duSpan pointer" id="hrCogBtn'+value.Id+'">Hours: <span style="color:'+HourColor+'"><input type="text" style="color:'+HourColor+';width:'+widHr+'; font-size: 12px !important" class="duarationClass duSInput hrCogBtn'+value.Id+'" onkeyup="goforduration($(this).data(\'id\'),' + value.Id + ',\'task\',event)" onchange="getDurationhr($(this).data(\'id\'),' + value.Id + ',\'subtask\')" data-id="hrduration' + value.Id + '" id="hrduration' + value.Id + '" value="'+endcColorS+'"/></span> </span></span>|';
