<!DOCTYPE html><html> <head> <meta charset="utf-8"> <meta name="viewport" content="width=device-width"> <title>Privacy Policy</title> <style>body{font-family: "Helvetica Neue", Helvetica, Arial, sans-serif; padding:1em;margin:4% 15%;-webkit-box-shadow: 1px 1px 0px 5px rgba(0,0,0,0.1);
-moz-box-shadow: 1px 1px 0px 5px rgba(0,0,0,0.1);
box-shadow: 1px 1px 0px 5px rgba(0,0,0,0.1);border-radius: 5px;}</style></head> <body><h2>Privacy Policy</h2> <p> Imagine Technologies Pvt. Ltd. built the [NavCon] app as a Free app. This SERVICE is provided by Imagine Technologies Pvt. Ltd. at no cost and is intended for use as is.
                    ...
                    at [NavCon] unless otherwise defined in this Privacy Policy.
                  ...
                  </p> <p>The app does use third party services that may collect information used to identify you.</p> <div><p>Link to privacy policy of third party service providers used by the app </p> <ul><li><a href="https://slack.com/privacy-policy" target="_blank">Privacy Policy</a></li> <!----> <!----> <!----></ul></div> <p><strong>Log Data</strong></p> <p> We want to inform you that whenever you use our Service, in a case of an
